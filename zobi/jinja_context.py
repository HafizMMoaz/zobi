...
from zobi.constants import LRU_CACHE_MAX_SIZE, NO_TIME_RANGE
...
class UndefinedTemplateFunctionException(ZobiTemplateException):
...
class ExtraCache:
    ...
    def url_param(
        ...
        from zobi.views.utils import get_form_data
...
class BaseTemplateProcessor:
    ...
    def process_template(self, sql: str, **kwargs: Any) -> str:
        ...
        try:
            ...
            raise ZobiSyntaxErrorException([error]) from ex
            ...
            raise ZobiTemplateException(message) from ex
...
def get_dataset_id_from_context(metric_key: str) -> int:
    ...
    from zobi.views.utils import loads_request_json
    ...
    if form_data := (form_data or getattr(g, "form_data", {})):
        ...
        if chart_id := (form_data.get("slice_id") or url_params.get("slice_id")):
            ...
            if not chart_data:
                raise ZobiTemplateException(exc_message)
