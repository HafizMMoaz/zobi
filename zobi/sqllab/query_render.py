...
from zobi.commands.sql_lab.execute import SqlQueryRender
from zobi.errors import ZobiErrorType
from zobi.sqllab.exceptions import SqlLabException
...
class SqlQueryRenderImpl(SqlQueryRender):
    ...
    def render(self, execution_context: SqlJsonExecutionContext) -> str:
        ...
        try:
            ...
            from zobi.jinja_context import UndefinedTemplateFunctionException
    ...
    def _raise_undefined_parameter_exception(
        ...
        raise SqlQueryRenderException(
            ...
            error_type=ZobiErrorType.MISSING_TEMPLATE_PARAMS_ERROR,
    ...
    def _raise_template_exception(
        ...
        raise SqlQueryRenderException(
            sql_json_execution_context=execution_context,
            error_type=ZobiErrorType.INVALID_TEMPLATE_PARAMS_ERROR,
            reason_message=__(
