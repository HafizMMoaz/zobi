...
from zobi.commands.sql_lab.estimate import QueryEstimationCommand
from zobi.commands.sql_lab.execute import CommandResult, ExecuteSqlCommand
from zobi.commands.sql_lab.export import SqlResultExportCommand
from zobi.commands.sql_lab.results import SqlExecutionResultsCommand
from zobi.commands.sql_lab.streaming_export_command import (
...
from zobi.sql_lab import get_sql_results
from zobi.sqllab.command_status import SqlJsonExecutionStatus
from zobi.sqllab.exceptions import (
    QueryIsForbiddenToAccessException,
    SqlLabException,
)
from zobi.sqllab.execution_context_convertor import ExecutionContextConvertor
from zobi.sqllab.query_render import SqlQueryRenderImpl
from zobi.sqllab.schemas import (
...
from zobi.sqllab.sql_json_executer import (
...
class SqlLabRestApi(BaseZobiApi):
    ...
    def export_csv(self, client_id: str) -> CsvResponse:
        ...
        ) and not security_manager.can_access("can_export_data", "Zobi"):
