...
from zobi_core.tasks.types import TaskProperties, TaskScope, TaskStatus

from zobi.daos.base import BaseDAO
from zobi.daos.exceptions import DAODeleteFailedError
from zobi.extensions import db
from zobi.models.task_subscribers import TaskSubscriber
from zobi.models.tasks import Task
from zobi.tasks.constants import ABORTABLE_STATES, TERMINAL_STATES
from zobi.tasks.filters import TaskFilter
from zobi.tasks.utils import get_active_dedup_key, get_finished_dedup_key, json
...
class TaskDAO(BaseDAO[Task]):
    ...
    def abort_task(cls, task_uuid: UUID, skip_base_filter: bool = False) -> Task | None:
        ...
        """
        from zobi.commands.tasks.exceptions import TaskNotAbortableError
