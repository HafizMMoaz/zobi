...
from zobi.utils.encrypt import SecretsMigrator
...
def sync_tags() -> None:
    ...
    from zobi.common.tags import add_favorites, add_owners, add_types
...
def update_api_docs() -> None:
    ...
    zobi_dir = os.path.abspath(os.path.dirname(__file__))
    openapi_json = os.path.join(
        zobi_dir, "..", "..", "docs", "static", "resources", "openapi.json"
    )
    api_version = "v1"
