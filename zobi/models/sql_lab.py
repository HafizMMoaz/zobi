...
from zobi_core.queries.models import (
    Query as CoreQuery,
...
class SqlTablesMixin:  # pylint: disable=too-few-public-methods
    ...
    def sql_tables(self) -> list[Table]:
        ...
        except (ZobiSecurityException, ZobiParseError, TemplateError):
            return []
...
class Query(
    ...
    # Could be configured in the zobi config.
...
class SavedQuery(
    ...
    tags = relationship(
        ...
        viewonly=True,  # cascading deletion already handled by zobi.tags.models.ObjectUpdater.after_delete  # noqa: E501
    )
