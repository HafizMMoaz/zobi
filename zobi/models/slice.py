...
from zobi_core.common.models import Chart as CoreChart
...
from zobi.thumbnails.digest import get_chart_digest
from zobi.utils import core as utils, json
from zobi.viz import BaseViz, viz_types
...
class Slice(  # pylint: disable=too-many-public-methods
    ...
    def explore_json_url(self) -> str:
        """Defines the url to access the slice"""
        return self.get_explore_url("/zobi/explore_json")
