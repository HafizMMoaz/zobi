...
from zobi_core.common.models import Dashboard as CoreDashboard
...
from zobi.tasks.thumbnails import cache_dashboard_thumbnail
from zobi.tasks.utils import get_current_user
from zobi.thumbnails.digest import get_dashboard_digest
