...
from zobi_core.tasks.models import Task as CoreTask
from zobi_core.tasks.types import TaskProperties, TaskStatus
...
class Task(CoreTask, AuditMixinNullable, Model):
    ...
    This model represents async tasks in Zobi, providing unified tracking
