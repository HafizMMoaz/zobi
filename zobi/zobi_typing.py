...
if TYPE_CHECKING:
    from zobi.utils.core import GenericDataType, QueryObjectFilterClause
...
class ResultSetColumnType(TypedDict):
    """
    Zobi virtual dataset column interface
    """
...
class QueryObjectDict(TypedDict, total=False):
    """
    TypedDict representation of query objects used throughout Zobi.

    This represents the dictionary output from QueryObject.to_dict() and is used
    in datasource query methods throughout Zobi.
