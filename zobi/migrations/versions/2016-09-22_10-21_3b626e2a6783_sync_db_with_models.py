...
from zobi import db
from zobi.utils.core import generic_find_constraint_name
...
def upgrade():
    # cleanup after: https://github.com/airbnb/zobi/pull/1078
    try:
    ...
    # fixed issue: https://github.com/airbnb/zobi/issues/466
    try:
