...
from zobi.commands.database.delete import DeleteDatabaseCommand
...
from zobi.commands.database.importers.dispatcher import ImportDatabasesCommand
from zobi.commands.database.oauth2 import OAuth2StoreTokenCommand
from zobi.commands.database.ssh_tunnel.exceptions import (
    SSHTunnelDatabasePortError,
    SSHTunnelingNotEnabledError,
)
from zobi.commands.database.sync_permissions import SyncPermissionsCommand
...
from zobi.commands.database.validate_sql import ValidateSQLCommand
...
from zobi.databases.decorators import check_table_access
from zobi.databases.filters import DatabaseFilter, DatabaseUploadEnabledFilter
from zobi.databases.schemas import (
...
from zobi.databases.utils import get_table_metadata
...
class DatabaseRestApi(BaseZobiModelRestApi):
    ...
    def oauth2(self) -> FlaskResponse:
        ...
        return make_response(
            render_template("zobi/oauth2.html", tab_id=tab_id),
            200,
        )
