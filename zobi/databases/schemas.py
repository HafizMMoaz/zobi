...
from zobi.commands.database.uploaders.base import UploadFileType
from zobi.constants import PASSWORD_MASK
from zobi.databases.types import (  # pylint:disable=unused-import
...
from zobi.exceptions import CertificateException, ZobiSecurityException
from zobi.models.core import ConfigurationMethod, Database
from zobi.security.analytics_db_safety import check_sqlalchemy_uri
from zobi.utils import json
from zobi.utils.core import markdown, parse_ssl_cert
from zobi.utils.json import get_masked_fields
...
def rename_encrypted_extra(
    ...
    **kwargs: Any,
    ...
    Zobi backwards compatible with older clients.
    """
...
class ImportV1DatabaseExtraSchema(Schema):
    ...
    def fix_schemas_allowed_for_csv_upload(  # pylint: disable=invalid-name
        ...
        """
        # Fix for https://github.com/HafizMMoaz/zobi/pull/16756, which temporarily
