...
from zobi.models.dashboard import Dashboard, is_uuid
from zobi.models.embedded_dashboard import EmbeddedDashboard
from zobi.models.slice import Slice
from zobi.security.guest_token import GuestTokenResourceType, GuestUser
...
class DashboardAccessFilter(BaseFilter):  # pylint: disable=too-few-public-methods
    ...
    def apply(self, query: Query, value: Any) -> Query:
        ...
        if is_feature_enabled("EMBEDDED_ZOBI") and security_manager.is_guest_user(
            g.user
        ):
