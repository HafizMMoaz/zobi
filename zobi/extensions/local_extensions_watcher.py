    ...
    try:
        ...
        class LocalExtensionFileHandler(FileSystemEventHandler):
            ...
            def on_any_event(self, event: Any) -> None:
                ...
                # Touch zobi/__init__.py to trigger Flask's file watcher
                zobi_init = Path("zobi/__init__.py")
                logger.info("Triggering restart by touching %s", zobi_init)
                os.utime(zobi_init, (time.time(), time.time()))
