"""Zobi wrapper around pyarrow.Table."""
...
class ZobiResultSet:
    def __init__(  # pylint: disable=too-many-locals  # noqa: C901
        ...
        if cursor_description:
            ...
            # See https://github.com/HafizMMoaz/zobi/issues/23848
        ...
        for column in column_names:
            try:
                ...
                # https://issues.zobi.dev/jira/browse/ARROW-7855
            ):
        ...
        if pa_data:  # pylint: disable=too-many-nested-blocks
            for i, column in enumerate(column_names):
                if pa.types.is_nested(pa_data[i].type):
                    ...
                    #  are added as a natively supported column type in Zobi
                    #  (zobi.utils.core.GenericDataType).
                    stringified_arr = stringify_values(array[column])
                    ...
                    # related: https://issues.zobi.dev/jira/browse/ARROW-5248
