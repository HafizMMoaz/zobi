...
from zobi.async_events.async_query_manager import AsyncQueryTokenException
from zobi.charts.api import ChartRestApi
from zobi.charts.client_processing import apply_client_processing
from zobi.charts.data.dashboard_filter_context import (
    DashboardFilterContext,
    get_dashboard_filter_context,
)
from zobi.charts.data.query_context_cache_loader import QueryContextCacheLoader
from zobi.charts.schemas import ChartDataQueryContextSchema
from zobi.commands.chart.data.create_async_job_command import (
    CreateAsyncChartDataJobCommand,
)
from zobi.commands.chart.data.get_data_command import ChartDataCommand
from zobi.commands.chart.data.streaming_export_command import (
...
from zobi.constants import (
    CACHE_DISABLED_TIMEOUT,
    EXTRA_FORM_DATA_OVERRIDE_EXTRA_KEYS,
    EXTRA_FORM_DATA_OVERRIDE_REGULAR_MAPPINGS,
)
from zobi.daos.exceptions import DatasourceNotFound
from zobi.exceptions import QueryObjectValidationError, ZobiSecurityException
...
from zobi.utils.decorators import logs_context
from zobi.views.base import CsvResponse, generate_download_headers, XlsxResponse
...
class ChartDataRestApi(ChartRestApi):
    ...
    def _create_streaming_csv_response(
        ...
        if not filename:
            ...
            filename = secure_filename(f"zobi_{chart_name}_{timestamp}.csv")
        ...
        # TODO: Make chunk size configurable via ZOBI_CONFIG
        chunk_size = 1024
