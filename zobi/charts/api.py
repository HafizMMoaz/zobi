...
from zobi.charts.filters import (
    ChartAllTextFilter,
...
from zobi.commands.chart.delete import DeleteChartCommand
...
from zobi.commands.chart.fave import AddFavoriteChartCommand
from zobi.commands.chart.importers.dispatcher import ImportChartsCommand
from zobi.commands.chart.unfave import DelFavoriteChartCommand
from zobi.commands.chart.update import UpdateChartCommand
from zobi.commands.chart.warm_up_cache import ChartWarmUpCacheCommand
from zobi.commands.exceptions import CommandException, TagForbiddenError
from zobi.commands.importers.exceptions import (
...
from zobi.tasks.thumbnails import cache_chart_thumbnail
...
class ChartRestApi(BaseZobiModelRestApi):
    ...
    def cache_screenshot(self, pk: int, **kwargs: Any) -> WerkzeugResponse:
        ...
        chart_url = get_url_path("Zobi.slice", slice_id=chart.id)
    ...
    def thumbnail(self, pk: int, digest: str, **kwargs: Any) -> WerkzeugResponse:
        ...
        url = get_url_path("Zobi.slice", slice_id=chart.id)
