...
from zobi.tags.models import Tag, TaggedObject
from zobi.tasks.exceptions import ExecutorNotFoundError, InvalidExecutorError
from zobi.tasks.utils import fetch_csrf_token, get_executor
from zobi.utils import json
from zobi.utils.date_parser import parse_human_datetime
from zobi.utils.machine_auth import MachineAuthProvider
from zobi.utils.urls import get_url_path, is_secure_url
...
class Strategy:  # pylint: disable=too-few-public-methods
    ...
    Strategies can be configured in `zobi/config.py`:
