...
from zobi_core.tasks.types import (
...
from zobi.tasks.utils import progress_update

if TYPE_CHECKING:
    from zobi.models.tasks import Task
    from zobi.tasks.manager import AbortListener
...
class TaskContext(CoreTaskContext):
    ...
    def _write_to_db(self) -> None:
        ...
        """
        from zobi.commands.tasks.internal_update import InternalUpdateTaskCommand
    ...
    def _write_handler_failures_to_db(self) -> None:
        ...
        """
        from zobi.commands.tasks.update import UpdateTaskCommand
