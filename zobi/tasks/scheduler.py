...
from zobi.commands.logs.prune import LogPruneCommand
...
from zobi.commands.sql_lab.query import QueryPruneCommand
...
from zobi.tasks.constants import ABORT_STATES, TERMINAL_STATES
from zobi.tasks.context import TaskContext
from zobi.tasks.cron_util import cron_schedule_window
from zobi.tasks.manager import TaskManager
from zobi.tasks.registry import TaskRegistry
from zobi.utils.core import LoggerLevel
...
def execute_task(  # noqa: C901
    ...
    """
    from zobi.commands.tasks.internal_update import InternalStatusTransitionCommand
