...
from zobi import security_manager, thumbnail_cache
from zobi.extensions import celery_app
from zobi.security.guest_token import GuestToken
...
from zobi.utils.webdriver import WindowSize
...
def cache_dashboard_thumbnail(
    ...
    url = get_url_path("Zobi.dashboard", dashboard_id_or_slug=dashboard.id)
