...
from zobi.tags.filters import UserCreatedTagTypeFilter
from zobi.tags.models import ObjectType, Tag
from zobi.tags.schemas import (
    delete_tags_schema,
...
class TagRestApi(BaseZobiModelRestApi):
