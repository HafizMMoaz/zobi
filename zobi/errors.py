...
ISSUE_CODES = {
    ...
    1010: _("Zobi encountered an error while running a command."),
    1011: _("Zobi encountered an unexpected error."),
...
ERROR_TYPES_TO_ISSUE_CODES_MAPPING = {
    ZobiErrorType.ADHOC_SUBQUERY_NOT_ALLOWED_ERROR: [1037],
    ZobiErrorType.BACKEND_TIMEOUT_ERROR: [1000, 1001],
    ZobiErrorType.GENERIC_DB_ENGINE_ERROR: [1002],
    ZobiErrorType.COLUMN_DOES_NOT_EXIST_ERROR: [1003, 1004],
    ZobiErrorType.TABLE_DOES_NOT_EXIST_ERROR: [1003, 1005],
    ZobiErrorType.SCHEMA_DOES_NOT_EXIST_ERROR: [1003, 1016],
    ZobiErrorType.MISSING_TEMPLATE_PARAMS_ERROR: [1006],
    ZobiErrorType.INVALID_TEMPLATE_PARAMS_ERROR: [1028],
    ZobiErrorType.RESULTS_BACKEND_NOT_CONFIGURED_ERROR: [1021],
    ZobiErrorType.DML_NOT_ALLOWED_ERROR: [1022],
    ZobiErrorType.CONNECTION_INVALID_HOSTNAME_ERROR: [1007],
    ZobiErrorType.CONNECTION_PORT_CLOSED_ERROR: [1008],
    ZobiErrorType.CONNECTION_HOST_DOWN_ERROR: [1009],
    ZobiErrorType.GENERIC_COMMAND_ERROR: [1010],
    ZobiErrorType.GENERIC_BACKEND_ERROR: [1011],
    ZobiErrorType.CONNECTION_INVALID_USERNAME_ERROR: [1012],
    ZobiErrorType.CONNECTION_INVALID_PASSWORD_ERROR: [1013],
    ZobiErrorType.CONNECTION_ACCESS_DENIED_ERROR: [1014, 1015],
    ZobiErrorType.CONNECTION_UNKNOWN_DATABASE_ERROR: [1015],
    ZobiErrorType.CONNECTION_DATABASE_PERMISSIONS_ERROR: [1017],
    ZobiErrorType.CONNECTION_MISSING_PARAMETERS_ERROR: [1018],
    ZobiErrorType.INVALID_PAYLOAD_FORMAT_ERROR: [1019],
    ZobiErrorType.INVALID_PAYLOAD_SCHEMA_ERROR: [1020],
    ZobiErrorType.INVALID_CTAS_QUERY_ERROR: [1023],
    ZobiErrorType.INVALID_CVAS_QUERY_ERROR: [1024, 1025],
    ZobiErrorType.INVALID_SQL_ERROR: [1003],
    ZobiErrorType.SQLLAB_TIMEOUT_ERROR: [1026, 1027],
    ZobiErrorType.OBJECT_DOES_NOT_EXIST_ERROR: [1029],
    ZobiErrorType.SYNTAX_ERROR: [1030],
    ZobiErrorType.RESULTS_BACKEND_ERROR: [1031, 1032, 1033],
    ZobiErrorType.CONNECTION_INVALID_PORT_ERROR: [1034],
    ZobiErrorType.ASYNC_WORKERS_ERROR: [1035],
    ZobiErrorType.DATABASE_NOT_FOUND_ERROR: [1011, 1036],
    ZobiErrorType.CONNECTION_DATABASE_TIMEOUT: [1001, 1009],
    ZobiErrorType.MARSHMALLOW_ERROR: [1040],
    ZobiErrorType.RESULT_TOO_LARGE_ERROR: [1041],
}
