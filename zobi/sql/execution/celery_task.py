...
from zobi.utils.core import override_user, zlib_compress
...
def _serialize_payload(payload: dict[Any, Any]) -> bytes:
    ...
    from zobi import results_backend_use_msgpack
...
def _finalize_successful_query(
    ...
    execution_results: list[tuple[str, ZobiResultSet | None, float, int]],
