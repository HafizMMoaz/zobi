...
from zobi.cli.test_loaders import load_big_data
...
def discover_datasets() -> Dict[str, Callable[..., None]]:
    ...
    Examples are organized as:
        zobi/examples/{example_name}/data.parquet           # Single dataset
        zobi/examples/{example_name}/data/{name}.parquet    # Multiple datasets
