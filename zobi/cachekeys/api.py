...
from zobi.cachekeys.schemas import CacheInvalidationRequestSchema
from zobi.connectors.sqla.models import SqlaTable
from zobi.extensions import cache_manager, db, event_logger, stats_logger_manager
from zobi.models.cache import CacheKey
from zobi.views.base_api import BaseZobiModelRestApi, statsd_metrics

logger = logging.getLogger(__name__)


class CacheRestApi(BaseZobiModelRestApi):
