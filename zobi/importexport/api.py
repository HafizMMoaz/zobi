...
from zobi.commands.export.assets import ExportAssetsCommand
...
from zobi.views.base_api import BaseZobiApi, requires_form_data, statsd_metrics


class ImportExportRestApi(BaseZobiApi):
    """
    ...
    def export(self) -> Response:
        ...
        get:
          ...
          description: >-
            Gets a ZIP file with all the Zobi assets (databases, datasets, charts,
