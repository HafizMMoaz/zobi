...
from zobi.exceptions import ZobiMarshmallowValidationError
from zobi.models.sql_types import parse_currency_string
...
class DatasetPutSchema(Schema):
    ...
    def handle_error(
        ...
        **kwargs: Any,
        ...
        Return SIP-40 error.
        """
        raise ZobiMarshmallowValidationError(error, data)
