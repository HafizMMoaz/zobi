...
from zobi.commands.dataset.delete import DeleteDatasetCommand
from zobi.commands.dataset.duplicate import DuplicateDatasetCommand
...
from zobi.commands.dataset.importers.dispatcher import ImportDatasetsCommand
from zobi.commands.dataset.refresh import RefreshDatasetCommand
from zobi.commands.dataset.update import UpdateDatasetCommand
...
from zobi.databases.filters import DatabaseFilter
from zobi.datasets.filters import DatasetCertifiedFilter, DatasetIsNullOrEmptyFilter
from zobi.datasets.schemas import (
...
from zobi.exceptions import ZobiSyntaxErrorException, ZobiTemplateException
from zobi.jinja_context import BaseTemplateProcessor, get_template_processor
from zobi.utils import json
from zobi.utils.core import parse_boolean_string
from zobi.views.base import DatasourceFilter
...
class DatasetRestApi(BaseZobiModelRestApi):
    ...
    def render_dataset_fields(
        ...
        for item_type, key, new_key, func in items:
            ...
            except (TemplateSyntaxError, ZobiSyntaxErrorException) as ex:
                template_exception = ZobiTemplateException(
