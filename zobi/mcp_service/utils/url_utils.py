...
def get_zobi_base_url() -> str:
    """
    Get the Zobi base URL from configuration.

    Returns:
        Base URL for Zobi web server (e.g., "http://localhost:9001")
    """
...
def get_mcp_service_url() -> str:
    ...
    Zobi URL with /mcp prefix. In development,
