...
This module provides utilities for working with Zobi's cache layers
...
from zobi.mcp_service.common.cache_schemas import CacheStatus
...
def get_cache_status_from_result(
    ...
    """
    Extract cache status information from a Zobi query result.

    Args:
        result: Query result dictionary from Zobi
