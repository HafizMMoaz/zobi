...
def _create_dashboard_layout(chart_objects: List[Any]) -> Dict[str, Any]:
    ...
    matching the component structure that the Zobi frontend expects.
    ...
    # Grid configuration based on real Zobi dashboard patterns
...
def generate_dashboard(  # noqa: C901
    ...
    try:
        ...
        dashboard_info = DashboardInfo(
            ...
            url=f"{get_zobi_base_url()}/zobi/dashboard/{dashboard.id}/",
            chart_count=len(request.chart_ids),
            tags=[
