...
from zobi.mcp_service.constants import ModelType
from zobi.mcp_service.mcp_core import ModelGetSchemaCore
...
def _get_database_schema_core() -> ModelGetSchemaCore[ModelSchemaInfo]:
    ...
    from zobi.mcp_service.common.schema_discovery import DATABASE_EXCLUDE_COLUMNS
