...
@mcp.resource("zobi://schema/chart")
@mcp_auth_hook
...
@mcp.resource("zobi://schema/dataset")
@mcp_auth_hook
...
@mcp.resource("zobi://schema/dashboard")
@mcp_auth_hook
...
def get_all_schemas_resource() -> str:
    ...
    all_schemas = {
        ...
        "metadata": {
            "description": "Schema discovery metadata for Zobi MCP service",
            "usage": {
