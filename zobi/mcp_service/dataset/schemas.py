...
from zobi.mcp_service.chart.schemas import DataColumn, PerformanceMetadata
...
class CreateVirtualDatasetResponse(BaseModel):
    ...
    url: str | None = Field(
        None,
        description="URL to view/edit the dataset in Zobi. None if failed.",
    )
