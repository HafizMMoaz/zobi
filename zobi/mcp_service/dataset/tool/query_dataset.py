...
from zobi.mcp_service.utils.oauth2_utils import build_oauth2_redirect_message
...
async def query_dataset(  # noqa: C901
    ...
    try:
        ...
        with event_logger.log_context(action="mcp.query_dataset.execute"):
            ...
            # datasets (Zobi's built-in semantic layer). External semantic
    ...
    except (CommandException, ZobiException) as exc:
