...
# This replaces the abstract @tool and @prompt decorators in zobi_core.api.mcp
# with concrete implementations that can register with the mcp instance
from zobi.core.mcp.core_mcp_injection import (  # noqa: E402
...
# Tools use the @tool decorator from `core` and register automatically
...
from zobi.mcp_service.chart import (  # noqa: F401, E402
...
from zobi.mcp_service.dashboard.tool import (  # noqa: F401, E402
    add_chart_to_existing_dashboard,
    generate_dashboard,
    get_dashboard_info,
    list_dashboards,
)
from zobi.mcp_service.database.tool import (  # noqa: F401, E402
    get_database_info,
    list_databases,
)
from zobi.mcp_service.dataset.tool import (  # noqa: F401, E402
    create_virtual_dataset,
    get_dataset_info,
    list_datasets,
    query_dataset,
)
from zobi.mcp_service.explore.tool import (  # noqa: F401, E402
    generate_explore_link,
)
from zobi.mcp_service.sql_lab.tool import (  # noqa: F401, E402
    execute_sql,
    open_sql_lab_with_context,
    save_sql_query,
)
from zobi.mcp_service.system import (  # noqa: F401, E402
    prompts as system_prompts,
    resources as system_resources,
)
from zobi.mcp_service.system.tool import (  # noqa: F401, E402
    find_users,
    generate_bug_report,
    get_instance_info,
    get_schema,
...
def _remove_disabled_tools(disabled_tools: set[str]) -> None:
    ...
    this via MCP_DISABLED_TOOLS in zobi_config.py.
    """
...
def init_fastmcp_server(
    ...
    **kwargs: Any,
    ...
    from zobi.mcp_service.flask_singleton import app as flask_app

    # Derive branding from Zobi's APP_NAME config (defaults to "Zobi")
    app_name = flask_app.config.get("APP_NAME", "Zobi")
    branding = app_name
