...
from zobi.daos.base import BaseDAO, ColumnOperator, ColumnOperatorEnum
from zobi.extensions import db
from zobi.mcp_service.constants import MAX_PAGE_SIZE, ModelType
...
from zobi.mcp_service.system.schemas import PaginationInfo
from zobi.mcp_service.utils import _is_uuid
from zobi.mcp_service.utils.permissions_utils import get_current_user
from zobi.mcp_service.utils.schema_utils import (
    parse_json_or_list,
...
class ModelGetInfoCore(BaseCore):
    ...
    def _find_object(self, identifier: int | str) -> Any:
        ...
        if self.supports_slug:
            ...
            from zobi.models.dashboard import id_or_slug_filter
...
class InstanceInfoCore(BaseCore):
    ...
    Provides a flexible way to gather and present statistics about a Zobi
