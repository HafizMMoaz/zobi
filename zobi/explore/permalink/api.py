...
from zobi.explore.permalink.exceptions import ExplorePermalinkInvalidStateError
from zobi.explore.permalink.schemas import ExplorePermalinkStateSchema
...
class ExplorePermalinkRestApi(BaseZobiApi):
