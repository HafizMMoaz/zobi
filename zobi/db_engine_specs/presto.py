...
from zobi import cache_manager, db, is_feature_enabled
...
from zobi.models.sql_types.presto_sql_types import (
    Array,
    Date,
    Interval,
    Map,
...
class PrestoBaseEngineSpec(BaseEngineSpec, metaclass=ABCMeta):
    ...
    def convert_dttm(
        ...
        Zobi only defines time zone naive `datetime` objects, though this method
        ...
        **kwargs: Any,
        ...
        for k in kwargs.keys():  # pylint: disable=consider-iterating-dictionary
            if k not in k in part_fields:  # pylint: disable=comparison-with-itself
                ...
                raise ZobiTemplateException(msg)
...
class PrestoEngineSpec(PrestoBaseEngineSpec):
    ...
    metadata = {
        ...
        "install_instructions": 'pip install "zobi[presto]"',
    ...
    def get_extra_table_metadata(
        ...
        try:
            ...
            raise ZobiDBAPIProgrammingError(
