...
from zobi.databases.schemas import encrypted_field_properties, EncryptedString
...
class BigQueryEngineSpec(BaseEngineSpec):  # pylint: disable=too-many-public-methods
    ...
    custom_errors: dict[Pattern[str], tuple[str, ZobiErrorType, dict[str, Any]]] = {
        ...
        SCHEMA_DOES_NOT_EXIST_REGEX: (
            ...
            ZobiErrorType.SCHEMA_DOES_NOT_EXIST_ERROR,
            {},
        ),
        SYNTAX_ERROR_REGEX: (
            __(
    ...
    def df_to_sql(
        ...
        if not table.schema:
            raise ZobiException("The table schema must be defined")
    ...
    def _get_client(
        ...
        try:
            ...
            raise ZobiDBAPIConnectionError(
    ...
    def estimate_query_cost(  # pylint: disable=too-many-arguments
        ...
        if not cls.get_allow_cost_estimate(extra):
            raise ZobiException("Database does not support cost estimation")
    ...
    def get_catalog_names(
        ...
        with database.get_sqla_engine() as engine:
            try:
                client = cls._get_client(engine, database)
            except ZobiDBAPIConnectionError:
                logger.warning(
    ...
    def get_dbapi_exception_mapping(cls) -> dict[type[Exception], type[Exception]]:
        ...
        return {DefaultCredentialsError: ZobiDBAPIConnectionError}
