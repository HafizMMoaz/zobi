...
class ElasticSearchEngineSpec(BaseEngineSpec):  # pylint: disable=abstract-method
    ...
    def get_dbapi_exception_mapping(cls) -> dict[type[Exception], type[Exception]]:
        ...
        return {
            es_exceptions.DatabaseError: ZobiDBAPIDatabaseError,
            es_exceptions.OperationalError: ZobiDBAPIOperationalError,
            es_exceptions.ProgrammingError: ZobiDBAPIProgrammingError,
        }
