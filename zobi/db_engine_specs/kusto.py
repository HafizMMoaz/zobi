...
class KustoSqlEngineSpec(BaseEngineSpec):  # pylint: disable=abstract-method
    ...
    def get_dbapi_exception_mapping(cls) -> dict[type[Exception], type[Exception]]:
        ...
        return {
            kusto_exceptions.DatabaseError: ZobiDBAPIDatabaseError,
            kusto_exceptions.OperationalError: ZobiDBAPIOperationalError,
            kusto_exceptions.ProgrammingError: ZobiDBAPIProgrammingError,
        }
