...
from zobi.sql.parse import process_jinja_sql
from zobi.utils import core as utils, json
from zobi.utils.core import GenericDataType, QuerySource

if TYPE_CHECKING:
    from zobi.models.core import Database  # pragma: no cover
...
class PostgresEngineSpec(BasicParametersMixin, PostgresBaseEngineSpec):
    ...
    metadata = {
        ...
        "notes": "The psycopg2 library comes bundled with Zobi Docker images.",
        "connection_examples": [
            {
        ...
        "compatible_databases": [
            ...
            },
            {
                ...
                "notes": "psycopg2 comes bundled with Zobi Docker images.",
    ...
    def get_schema_from_engine_params(
        ...
        in Zobi because it breaks schema-level permissions, since it's impossible
        ...
        if search_path := options.get("search_path"):
            ...
            if len(schemas) > 1:
                raise Exception(  # pylint: disable=broad-exception-raised
                    ...
                    "Zobi is unable to determine the schema of unqualified table "
...
WHERE datistemplate = false;
    ...
    def get_extra_params(
        ...
        :raises ZobiException: If database extra json payload is unparseable
        """
        try:
            extra = json.loads(database.extra or "{}")
        except json.JSONDecodeError as ex:
            raise ZobiException("Unable to parse database extras") from ex
