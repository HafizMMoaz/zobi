...
This report is auto-generated by `python zobi/db_engine_specs/lint_metadata.py --markdown`.
...
| ClickHouse Connect (Zobi) | clickhouse.py | 0% | category, connection_string, description, pypi_packages | default_port, homepage_url, logo |
...
| Zobi meta database | zobi.py | 0% | category, connection_string, description, pypi_packages | default_port, homepage_url, logo |
| Drill | drill.py | 51% | connection_string, pypi_packages | default_port |
...
| Solr | solr.py | 70% | ✓ | default_port, logo |
| Spark SQL | spark.py | 70% | ✓ | default_port, logo |
...
| Hive | hive.py | 80% | ✓ | default_port |
| Impala | impala.py | 80% | ✓ | default_port |
| Kylin | kylin.py | 80% | ✓ | default_port |
| IBM Netezza Performance Server | netezza.py | 80% | ✓ | default_port |
| OceanBase | oceanbase.py | 80% | ✓ | default_port |
| Doris | doris.py | 81% | ✓ | default_port |
...
| Pinot | pinot.py | 81% | ✓ | default_port |
