...
from zobi.db_engine_specs.base import BaseEngineSpec, DatabaseCategory, LimitMethod
from zobi.errors import ErrorLevel, ZobiError, ZobiErrorType
from zobi.utils.core import GenericDataType, get_user_agent, QuerySource
...
DEFAULT_ACCESS_TOKEN_URL = (
    "https://app.motherduck.com/token-request?appName=Zobi&close=y"  # noqa: S105
)
