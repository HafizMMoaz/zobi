...
class TrinoEngineSpec(PrestoBaseEngineSpec):
    ...
    metadata = {
        ...
        "pypi_packages": ["trino"],
        "install_instructions": 'pip install "zobi[trino]"',
    ...
    def cancel_query(cls, cursor: Cursor, query: Query, cancel_query_id: str) -> bool:
        ...
        try:
            cursor.execute(
                ...
                "message => 'Query cancelled by Zobi')"
            )
