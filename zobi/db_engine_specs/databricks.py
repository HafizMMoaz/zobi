...
from zobi.utils.core import get_user_agent, QuerySource
...
def monkeypatch_dialect() -> None:
    ...
    fixed version requires SQLAlchemy>=2.0, which is not yet compatible with Zobi.
...
class DatabricksPythonConnectorEngineSpec(DatabricksDynamicBaseEngineSpec):
    ...
    metadata = {
        ...
        "pypi_packages": ["zobi[databricks]"],
        "install_instructions": "pip install zobi[databricks]",
        "connection_string": (
