...
that replaces the abstract functions in core during initialization.
"""
...
def create_tool_decorator(
    ...
    *,
    ...
    This combines FastMCP tool registration with optional Zobi authentication
    ...
    Args:
        ...
        protect: Whether to apply Zobi authentication (defaults to True)
    ...
    def decorator(func: F) -> F:
        try:
            ...
            if class_permission_name:
                from zobi.mcp_service.auth import (
...
def create_prompt_decorator(
    ...
    *,
    ...
    This combines FastMCP prompt registration with optional Zobi authentication,
...
def initialize_core_mcp_dependencies() -> None:
    ...
    in zobi_core.api.mcp with concrete implementations.

    Also imports MCP service app to register all host tools BEFORE extension loading.
    """
    import zobi_core.mcp.decorators
    ...
    try:
        ...
        logger.info(
            ...
            "Install it with: pip install 'zobi[fastmcp]'"
        )
        return

    # Replace the abstract decorators with concrete implementations
    zobi_core.mcp.decorators.tool = create_tool_decorator
    zobi_core.mcp.decorators.prompt = create_prompt_decorator
    ...
    try:
        ...
        from zobi.mcp_service import app  # noqa: F401
