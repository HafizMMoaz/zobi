...
from zobi.exceptions import InvalidPayloadFormatError
from zobi.extensions import db, event_logger, security_manager, stats_logger_manager
...
def requires_json(f: Callable[..., Any]) -> Callable[..., Any]:
    ...
    def wraps(self: BaseZobiModelRestApi, *args: Any, **kwargs: Any) -> Response:
...
def requires_form_data(f: Callable[..., Any]) -> Callable[..., Any]:
    ...
    def wraps(self: BaseZobiApiMixin, *args: Any, **kwargs: Any) -> Response:
...
class BaseZobiApi(BaseZobiApiMixin, BaseApi):
    pass


class BaseZobiModelRestApi(BaseZobiApiMixin, ModelRestApi):
    """
    Extends FAB's ModelResApi to implement specific zobi generic functionality
    """
    ...
    def _handle_filters_args(self, rison_args: dict[str, Any]) -> Filters:
        ...
        Applies to every subclass of ``BaseZobiModelRestApi``
