...
from zobi.utils.slack import get_user_avatar, SlackClientError
from zobi.views.base_api import BaseZobiApi, requires_json, statsd_metrics
from zobi.views.users.schemas import CurrentUserPutSchema, UserResponseSchema
from zobi.views.utils import bootstrap_user_data

user_response_schema = UserResponseSchema()


class CurrentUserRestApi(BaseZobiApi):
