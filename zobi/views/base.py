...
FRONTEND_CONF_KEYS = (
    "ZOBI_WEBSERVER_TIMEOUT",
    "ZOBI_DASHBOARD_POSITION_DATA_LIMIT",
    ...
    "ZOBI_CLIENT_RETRY_ATTEMPTS",
    "ZOBI_CLIENT_RETRY_DELAY",
    "ZOBI_CLIENT_RETRY_BACKOFF_MULTIPLIER",
    "ZOBI_CLIENT_RETRY_MAX_DELAY",
    "ZOBI_CLIENT_RETRY_JITTER_MAX",
    "ZOBI_CLIENT_RETRY_STATUS_CODES",
...
def deprecated(
    ...
    """
    A decorator to set an API endpoint from ZobiView has deprecated.
...
class BaseZobiView(BaseView):
    ...
    def render_app_template(
        ...
        **template_kwargs: Any,
        ...
        return self.render_template("zobi/spa.html", **context)
...
def get_environment_tag() -> dict[str, Any]:
    ...
    # default is ZOBI_ENV (from FLASK_ENV in previous versions)
...
def menu_data(user: User) -> dict[str, Any]:
    ...
    return {
        ...
        "brand": {
            "path": app.config["LOGO_TARGET_PATH"] or url_for("Zobi.welcome"),
...
def get_spa_template_context(
    ...
    **template_kwargs: Any,
    ...
    # Priority: theme brandAppName > APP_NAME config > "Zobi" default
    app_name_from_config = app.config.get("APP_NAME", "Zobi")
    ...
    default_title = theme_tokens.get("brandAppName", "Zobi")
