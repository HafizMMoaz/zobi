...
from zobi import appbuilder, dataframe, db, result_set, viz
...
from zobi.extensions import cache_manager, feature_flag_manager, security_manager
...
def get_datasource_info(
    ...
    :raises ZobiException: If the datasource no longer exists
    """
...
# /frontend/src/dashboard/util/componentTypes.js
...
def check_explore_cache_perms(_self: Any, cache_key: str) -> None:
    ...
    :param _self: the Zobi view instance
    ...
    **kwargs: Any,
    ...
    try:
        ...
        raise ZobiSecurityException(
            ZobiError(
                error_type=ZobiErrorType.FAILED_FETCHING_DATASOURCE_INFO_ERROR,
    ...
    if datasource_type is None:
        raise ZobiSecurityException(
            ZobiError(
                error_type=ZobiErrorType.UNKNOWN_DATASOURCE_TYPE_ERROR,
                level=ErrorLevel.ERROR,
...
def _deserialize_results_payload(
    ...
    if use_msgpack:
        ...
        df = result_set.ZobiResultSet.convert_table_to_df(pa_table)
