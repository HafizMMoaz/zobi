...
from zobi.utils.date_parser import get_since_until, parse_past_timedelta
...
class TimeTableViz(BaseViz):
    ...
    credits = 'a <a href="https://github.com/airbnb/zobi">Zobi</a> original'
    is_timeseries = True
...
class WorldMapViz(BaseViz):
    ...
    def get_data(self, df: pd.DataFrame) -> VizData:
        ...
        from zobi.examples import countries
