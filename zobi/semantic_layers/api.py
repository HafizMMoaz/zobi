...
from zobi import db, event_logger, is_feature_enabled, security_manager
from zobi.commands.semantic_layer.create import (
    CreateSemanticLayerCommand,
    CreateSemanticViewCommand,
)
from zobi.commands.semantic_layer.delete import (
...
from zobi.commands.semantic_layer.update import (
    UpdateSemanticLayerCommand,
    UpdateSemanticViewCommand,
)
from zobi.constants import MODEL_API_RW_METHOD_PERMISSION_MAP
from zobi.daos.semantic_layer import SemanticLayerDAO
from zobi.datasets.schemas import get_delete_ids_schema
...
from zobi.semantic_layers.schemas import (
...
class SemanticViewRestApi(BaseZobiModelRestApi):
...
class SemanticLayerRestApi(BaseZobiApi):
