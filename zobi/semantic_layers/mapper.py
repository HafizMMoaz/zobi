...
from zobi_core.semantic_layers.view import SemanticViewFeature

from zobi.common.db_query_status import QueryStatus
from zobi.common.query_object import QueryObject
from zobi.common.utils.time_range_utils import get_since_until_from_query_object
...
def get_results(query_object: QueryObject) -> QueryResult:
    ...
    :return: QueryResult compatible with Zobi's query interface
    """
