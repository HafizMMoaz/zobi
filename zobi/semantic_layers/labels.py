...
Mirror of frontend/src/features/semanticLayers/label.ts.
"""
...
def _sl(legacy: str, semantic: str) -> str:
    ...
    # (zobi.semantic_layers.labels is imported by zobi.initialization,
    # which is itself imported during zobi package initialization).
    from zobi import feature_flag_manager  # pylint: disable=import-outside-toplevel
