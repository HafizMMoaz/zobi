...
from zobi.commands.report.alert import AlertCommand
...
from zobi.exceptions import ZobiErrorsException, ZobiException
from zobi.extensions import feature_flag_manager, machine_auth_provider_factory
...
from zobi.reports.notifications import create_notification
...
from zobi.tasks.utils import get_executor
from zobi.utils import json
from zobi.utils.core import HeaderDataType, override_user, recipients_string_to_list
from zobi.utils.csv import get_chart_csv_data, get_chart_dataframe
from zobi.utils.decorators import logs_context, transaction
from zobi.utils.pdf import build_pdf_from_screenshots
from zobi.utils.screenshots import ChartScreenshot, DashboardScreenshot
...
class BaseReportState:
    ...
    def _send(
        ...
        """
        notification_errors: list[ZobiError] = []
        for recipient in recipients:
            ...
            try:
                ...
                notification_errors.append(
                    ZobiError(
                        message=ex.message,
                        error_type=ZobiErrorType.REPORT_NOTIFICATION_ERROR,
                        level=(
...
class ReportNotTriggeredErrorState(BaseReportState):
    ...
    def next(self) -> None:  # noqa: C901
        ...
        try:
        ...
        except (ZobiErrorsException, Exception) as first_ex:
            error_message = str(first_ex)
            if isinstance(first_ex, ZobiErrorsException):
            ...
            if not self.is_in_error_grace_period():
                ...
                except ZobiErrorsException as second_ex:
