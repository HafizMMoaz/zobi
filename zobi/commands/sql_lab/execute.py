...
if TYPE_CHECKING:
    ...
    from zobi.sqllab.sql_json_executer import SqlJsonExecutor
...
class ExecuteSqlCommand(BaseCommand):
    ...
    def run(
        ...
        except (ZobiErrorException, ZobiErrorsException):
            # to make sure we raising the original
            # ZobiErrorsException || ZobiErrorsException
            raise
