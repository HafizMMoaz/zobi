...
CACHE_IMPORT_PATH = "zobi.extensions.metastore_cache.ZobiMetastoreCache"

# Hash function lookup table matching zobi.utils.hashing
...
class ExploreFormDataCache(ZobiCache):
...
class CacheManager:
    def __init__(self) -> None:
        ...
        self._cache = ZobiCache()
        self._data_cache = ZobiCache()
        self._thumbnail_cache = ZobiCache()
        self._filter_state_cache = ZobiCache()
    ...
    def _init_cache(
        ...
        if (required and cache_type is None) or cache_type == "ZobiMetastoreCache":
