...
from zobi.reports.schemas import SlackChannelSchema
from zobi.utils import cache as cache_util
...
def get_channels_with_search(
    ...
    try:
        ...
        raise ZobiException(f"Failed to list channels: {ex}") from ex
...
def should_use_v2_api() -> bool:
    ...
    try:
        ...
        logger.warning(
            ...
            for the old Slack API will be removed in Zobi version 6.0.0."""
        )
        return False
