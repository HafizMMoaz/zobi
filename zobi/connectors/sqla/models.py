...
from zobi_core.common.models import Dataset as CoreDataset
...
from zobi.connectors.sqla.utils import (
    get_columns_description,
    get_physical_table_metadata,
    get_virtual_table_metadata,
)
from zobi.daos.exceptions import DatasourceNotFound
from zobi.db_engine_specs.base import BaseEngineSpec, TimestampExpression
...
from zobi.explorables.base import TimeGrainDict
...
class BaseDatasource(
    ...
    def query(self, query_obj: QueryObjectDict) -> QueryResult:
        ...
        query_obj is a dictionary representing Zobi's query interface.
        Should return a ``zobi.models.helpers.QueryResult``
        """
        raise NotImplementedError()
    ...
    def get_sqla_row_level_filters(
        ...
        try:
            ...
            if is_feature_enabled("EMBEDDED_ZOBI"):
            ...
            return all_filters
        except (TemplateError, ZobiSyntaxErrorException) as ex:
...
class SqlaTable(
        ...
        if col_in_metadata := self.get_column(metadata_lookup_key.strip()):
            ...
            if has_timegrain or force_type_check:
                try:
                    ...
                    if not col_desc:
                        raise ZobiGenericDBErrorException("Column not found")
                ...
                except ZobiGenericDBErrorException as ex:
    ...
    def get_extra_cache_keys(self, query_obj: QueryObjectDict) -> list[Hashable]:
        ...
        """
        from zobi.utils.rls import collect_rls_predicates_for_sql
