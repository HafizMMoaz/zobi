# Contributing to the Zobi Embedded SDK

The embedded-sdk directory is a self contained sub-project in the Zobi codebase.

This is because the SDK has different requirements from other parts of the Zobi codebase:
...
what happens if zobi is offline
what happens if the zobi domain is invalid or incorrect
