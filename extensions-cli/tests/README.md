...
This directory contains tests for the extensions-cli package, focusing on the `init` command and other CLI functionality.
...
```bash
pytest --cov=zobi_extensions_cli --cov-report=html
```
