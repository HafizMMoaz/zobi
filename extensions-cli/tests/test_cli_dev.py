...
from zobi_extensions_cli.cli import app, FrontendChangeHandler


# Dev Command Tests
@pytest.mark.cli
@patch("zobi_extensions_cli.cli.Observer")
@patch("zobi_extensions_cli.cli.init_frontend_deps")
@patch("zobi_extensions_cli.cli.rebuild_frontend")
@patch("zobi_extensions_cli.cli.rebuild_backend")
@patch("zobi_extensions_cli.cli.build_manifest")
@patch("zobi_extensions_cli.cli.write_manifest")
...
def test_dev_command_initial_build(
    ...
    with patch("zobi_extensions_cli.cli.Observer") as mock_observer_class:
        mock_observer = Mock()
        mock_observer_class.return_value = mock_observer
...
def test_frontend_watcher_function_coverage(isolated_filesystem):
    ...
    with patch("zobi_extensions_cli.cli.rebuild_frontend") as mock_rebuild:
        with patch("zobi_extensions_cli.cli.build_manifest") as mock_build:
            with patch("zobi_extensions_cli.cli.write_manifest") as mock_write:
...
def test_backend_watcher_function_coverage(isolated_filesystem):
    ...
    with patch("zobi_extensions_cli.cli.rebuild_backend") as mock_rebuild:
