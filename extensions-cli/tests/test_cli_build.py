...
import pytest
from zobi_extensions_cli.cli import (
    app,
    build_manifest,
    clean_dist,
    copy_backend_files,
...
# Build Command Tests
@pytest.mark.cli
@patch("zobi_extensions_cli.cli.validate_npm")
...
@patch("zobi_extensions_cli.cli.read_toml")
...
def test_clean_dist_frontend_removes_frontend_dist(isolated_filesystem):
    ...
    from zobi_extensions_cli.cli import clean_dist_frontend
...
def test_run_frontend_build_with_output_messages(isolated_filesystem):
    ...
    from zobi_extensions_cli.cli import run_frontend_build
...
def test_rebuild_frontend_handles_build_results(
    ...
    from zobi_extensions_cli.cli import rebuild_frontend
    ...
    with patch("zobi_extensions_cli.cli.run_frontend_build") as mock_build:
...
def test_rebuild_backend_calls_copy_and_shows_message(isolated_filesystem):
    ...
    from zobi_extensions_cli.cli import rebuild_backend
    ...
    with patch("zobi_extensions_cli.cli.copy_backend_files") as mock_copy:
