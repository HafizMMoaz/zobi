...
from zobi.db_engine_specs.hive import HiveEngineSpec, upload_to_s3
...
def test_df_to_sql_if_exists_fail(mock_g):
    ...
    with pytest.raises(ZobiException, match="Table already exists"):
        HiveEngineSpec.df_to_sql(
...
@mock.patch("zobi.db_engine_specs.hive.HiveEngineSpec._latest_partition_from_df")
...
@mock.patch("zobi.db_engine_specs.presto.PrestoEngineSpec.latest_partition")
...
@mock.patch("zobi.db_engine_specs.hive.HiveEngineSpec.get_view_names")
