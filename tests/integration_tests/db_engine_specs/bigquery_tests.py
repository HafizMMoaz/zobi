...
class TestBigQueryDbEngineSpec(ZobiTestCase):
    ...
    @mock.patch("zobi.db_engine_specs.bigquery.BigQueryEngineSpec.get_engine")
    @mock.patch("zobi.db_engine_specs.bigquery.pandas_gbq")
    @mock.patch("zobi.db_engine_specs.bigquery.service_account")
    ...
    def test_extract_errors(self):
        ...
        assert result == [
            ZobiError(
                ...
                error_type=ZobiErrorType.CONNECTION_DATABASE_PERMISSIONS_ERROR,
    ...
    @mock.patch("zobi.models.core.Database.db_engine_spec", BigQueryEngineSpec)
