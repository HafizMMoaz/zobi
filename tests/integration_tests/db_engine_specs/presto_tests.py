...
class TestPrestoDbEngineSpec(ZobiTestCase):
    @skipUnless(ZobiTestCase.is_module_installed("pyhive"), "pyhive not installed")
    ...
    def test_get_extra_table_metadata_no_table_found(self):
        ...
        from zobi.db_engine_specs.exceptions import ZobiDBAPIProgrammingError

        with pytest.raises(ZobiDBAPIProgrammingError):
    ...
    @mock.patch("zobi.db_engine_specs.base.BaseEngineSpec.get_table_names")
    @mock.patch("zobi.db_engine_specs.presto.PrestoEngineSpec.get_view_names")
    ...
    @mock.patch("zobi.db_engine_specs.base.BaseEngineSpec.select_star")
    ...
    @mock.patch("zobi.db_engine_specs.presto.is_feature_enabled")
    @mock.patch("zobi.db_engine_specs.base.BaseEngineSpec.select_star")
    ...
    def test_extract_errors(self):
        ...
        assert result == [
            ZobiError(
                ...
                error_type=ZobiErrorType.SCHEMA_DOES_NOT_EXIST_ERROR,
                level=ErrorLevel.ERROR,
                extra={
                    "engine_name": "Presto",
                    "issue_codes": [
