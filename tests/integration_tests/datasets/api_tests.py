...
class TestDatasetApi(ZobiTestCase):
    ...
    @patch("zobi.models.core.Database.get_columns")
    @patch("zobi.models.core.Database.has_table")
    @patch("zobi.models.core.Database.has_view")
    @patch("zobi.models.core.Database.get_table")
    ...
    @patch("zobi.daos.dataset.DatasetDAO.create")
    ...
    @patch("zobi.commands.dataset.create.security_manager.raise_for_access")
    def test_create_dataset_with_invalid_sql_validation(self, mock_raise_for_access):
        ...
        # Mock raise_for_access to throw ZobiParseError during validation
        mock_raise_for_access.side_effect = ZobiParseError(
    ...
    @patch("zobi.daos.dataset.DatasetDAO.update")
    ...
    @patch("zobi.daos.dataset.DatasetDAO.delete")
    ...
    @pytest.mark.usefixtures("create_datasets")
    @patch("zobi.daos.dataset.DatasetColumnDAO.delete")
    ...
    @pytest.mark.usefixtures("create_datasets")
    @patch("zobi.daos.dataset.DatasetMetricDAO.delete")
    ...
    def test_export_dataset(self):
        ...
        # debug with dump: https://github.com/HafizMMoaz/zobi/runs/1092546855
    ...
    def test_import_dataset_invalid(self):
        ...
        assert error["extra"]["issue_codes"][0]["code"] == 1010
        assert (
            "Issue 1010 - Zobi encountered an error while running a command."
    ...
    @patch("zobi.commands.dataset.create.CreateDatasetCommand.run")
    ...
    @patch("zobi.security.manager.ZobiSecurityManager.has_guest_access")
    @patch("zobi.security.manager.ZobiSecurityManager.is_guest_user")
