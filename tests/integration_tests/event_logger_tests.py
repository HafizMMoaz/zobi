...
class TestEventLogger(unittest.TestCase):
    ...
    def test_log_this(self, mock_log):
        ...
        with app.test_request_context("/zobi/dashboard/1/?myparam=foo"):
            result = test_func()
            ...
            assert payload["records"] == [
                {
                    "myparam": "foo",
                    "path": "/zobi/dashboard/1/",
                    "url_rule": "/zobi/dashboard/<dashboard_id_or_slug>/",
