...
class TestSecurityCsrfApi(ZobiTestCase):
...
class TestSecurityGuestTokenApi(ZobiTestCase):
...
class TestSecurityGuestTokenApiTokenValidator(ZobiTestCase):
    uri = "api/v1/security/guest_token/"
...
class TestSecurityRolesApi(ZobiTestCase):
...
class TestLogoutSessionInvalidation(ZobiTestCase):
