...
@patch("zobi.common.query_context.QueryContext.get_query_result")
...
class TestQueryContext(ZobiTestCase):
    @pytest.mark.usefixtures("load_birth_names_dashboard_with_slices")
...
def test_date_range_timeshift_invalid_format(app_context, physical_dataset):
    ...
    from zobi.commands.chart.exceptions import TimeDeltaAmbiguousError
