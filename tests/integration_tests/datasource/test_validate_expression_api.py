...
class TestDatasourceValidateExpressionApi(ZobiTestCase):
    """Test the datasource validate_expression API endpoint"""

    @patch("zobi.connectors.sqla.models.SqlaTable.validate_expression")
    ...
    def test_validate_expression_invalid_sql(self):
        ...
        with patch(
            "zobi.connectors.sqla.models.SqlaTable.validate_expression"
        ) as mock_validate:
