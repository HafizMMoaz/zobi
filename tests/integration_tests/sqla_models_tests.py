...
from zobi import db
from zobi.connectors.sqla.models import SqlaTable, TableColumn, SqlMetric
from zobi.constants import EMPTY_STRING, NULL_STRING
...
class TestDatabaseModel(ZobiTestCase):
    ...
    @patch("zobi.jinja_context.get_username", return_value="abc")
    ...
    @patch("zobi.jinja_context.get_dataset_id_from_context")
    ...
    @patch("zobi.models.core.Database.db_engine_spec", BigQueryEngineSpec)
...
@patch("zobi.jinja_context.get_user_id", return_value=1)
@patch("zobi.jinja_context.get_username", return_value="abc")
@patch("zobi.jinja_context.get_user_email", return_value="abc@test.com")
@patch(
    "zobi.jinja_context.security_manager.get_user_roles",
