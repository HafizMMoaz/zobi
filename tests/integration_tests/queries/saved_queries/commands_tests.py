...
from zobi.commands.query.importers.v1 import ImportSavedQueriesCommand
...
class TestExportSavedQueriesCommand(ZobiTestCase):
    ...
    @patch("zobi.queries.saved_queries.filters.g")
...
class TestImportSavedQueriesCommand(ZobiTestCase):
