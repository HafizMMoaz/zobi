...
class TestReportSchedulesApi(ZobiTestCase):
    @pytest.fixture
    def gamma_user_with_alerts_role(self):
        with self.create_app().app_context():
            user = self.create_user(
                ...
                "general",
                "Gamma",
                email=f"{REPORTS_GAMMA_USER}@zobi.org",
            )
    ...
    def test_create_report_schedule(self):
        ...
        report_schedule_data = {
            ...
            "recipients": [
                {
                    "type": ReportRecipientType.EMAIL,
                    "recipient_config_json": {"target": "target@zobi.org"},
                },
                {
    ...
    @patch("zobi.commands.dashboard.update.send_email_smtp")
