...
def test_execute_query_as_report_executor(
    ...
    override_user_mock = mocker.patch("zobi.commands.report.alert.override_user")
    cm = (
...
def test_execute_query_mutate_query_enabled(
    ...
    mocker.patch("zobi.commands.report.alert.override_user")
...
def test_execute_query_succeeded_no_retry(
    ...
    execute_query_mock = mocker.patch(
        "zobi.commands.report.alert.AlertCommand._execute_query",
...
def test_execute_query_succeeded_with_retries(
    ...
    from zobi.commands.report.alert import AlertCommand, AlertQueryError
    ...
    # Should match the value defined in zobi_test_config.py
...
def test_execute_query_failed_no_retry(
    ...
    from zobi.commands.report.alert import AlertCommand, AlertQueryTimeout
