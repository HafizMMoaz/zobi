...
@patch("zobi.tasks.scheduler.execute.apply_async")
...
@pytest.mark.usefixtures("app_context")
@patch("zobi.commands.report.execute.AsyncExecuteReportScheduleCommand.__init__")
@patch("zobi.commands.report.execute.AsyncExecuteReportScheduleCommand.run")
@patch("zobi.tasks.scheduler.execute.update_state")
...
@patch("zobi.tasks.scheduler.logger")
