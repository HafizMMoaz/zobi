...
def _create_world_bank_slices(table: SqlaTable) -> list[Slice]:
    from zobi.examples.world_bank import create_slices
...
def _create_world_bank_dashboard(table: SqlaTable) -> Dashboard:
    from zobi.examples.helpers import update_slice_ids
    from zobi.examples.world_bank import dashboard_positions
