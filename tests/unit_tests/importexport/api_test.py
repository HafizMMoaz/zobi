...
def test_export_assets(
    ...
    ExportAssetsCommand = mocker.patch("zobi.importexport.api.ExportAssetsCommand")  # noqa: N806
...
def test_import_assets(
    ...
    ImportAssetsCommand = mocker.patch("zobi.importexport.api.ImportAssetsCommand")  # noqa: N806
