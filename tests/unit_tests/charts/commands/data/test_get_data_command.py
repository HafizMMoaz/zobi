...
def test_query_result_type_allows_validation_error_payload() -> None:
    ...
    Context:
    - GitHub Issue #35492
    - Zobi 4.1.3 allowed errors to pass through
...
def test_get_query_catches_parsing_error() -> None:
    """
    Test that _get_query() catches ZobiParseError and returns both SQL and error.
    ...
    """
    from zobi.common.query_actions import _get_query
    ...
    # Create ZobiParseError with SQL in error.extra
    parse_error = ZobiParseError(
    ...
    with patch("zobi.common.query_actions._get_datasource") as mock_get_ds:
