...
class TestGetThemeBootstrapData:
    ...
    @patch("zobi.views.base.app")
    @patch("zobi.views.base.get_config_value")
    @patch("zobi.views.base.ThemeDAO")
...
class TestBrandAppNameFallback:
    ...
    @patch("zobi.views.base.get_spa_payload")
    @patch("zobi.views.base.app")
    def test_brandappname_uses_theme_value_when_set(self, mock_app, mock_payload):
        ...
        from zobi.views.base import get_spa_template_context
    ...
    def test_brandappname_falls_back_to_app_name_config(self, mock_app, mock_payload):
        ...
        # Mock payload with default "Zobi" brandAppName
        mock_payload.return_value = {
            "common": {
                "theme": {
                    "default": {
                        "token": {
                            "brandAppName": "Zobi",  # Default value
                            "brandLogoAlt": "Zobi",
                        }
                    }
                }
    ...
    @patch("zobi.views.base.get_spa_payload")
    @patch("zobi.views.base.app")
    def test_brandappname_uses_zobi_default_when_nothing_set(
        self, mock_app, mock_payload
    ):
        """Test fallback to 'Zobi' when neither is customized"""
        from zobi.views.base import get_spa_template_context

        mock_app.config = MagicMock()
        mock_app.config.get.side_effect = lambda k, d=None: {
            "APP_NAME": "Zobi",  # Default value
        }.get(k, d)
        ...
        # Should use default "Zobi"
        assert result["default_title"] == "Zobi"
        # Theme tokens should keep "Zobi"
        theme_tokens = result["theme_tokens"]
        assert theme_tokens["brandAppName"] == "Zobi"
    ...
    def test_brandappname_handles_empty_theme_config(self, mock_app, mock_payload):
        ...
        mock_payload.return_value = {
            "common": {
                "theme": {
                    "default": {"token": {"brandAppName": "Zobi"}},
