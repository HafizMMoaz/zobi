"""Unit tests for resource-level authorization in zobi/views/datasource/views.py.
...
def _get_view_func(name: str):
    ...
    from zobi.views.datasource.views import Datasource
...
@patch("zobi.views.datasource.views.security_manager", new_callable=MagicMock)
@patch("zobi.views.datasource.views.DatasourceDAO.get_datasource")
...
@patch("zobi.views.datasource.views.sanitize_datasource_data")
@patch("zobi.views.datasource.views.security_manager", new_callable=MagicMock)
@patch("zobi.views.datasource.views.DatasourceDAO.get_datasource")
...
@patch("zobi.views.datasource.views.security_manager", new_callable=MagicMock)
@patch("zobi.views.datasource.views.SqlaTable.get_datasource_by_name")
@patch("zobi.views.datasource.views.ExternalMetadataSchema")
...
@patch("zobi.views.datasource.views.SqlaTable.get_datasource_by_name")
@patch("zobi.views.datasource.views.ExternalMetadataSchema")
@patch("zobi.views.datasource.views.db")
...
def test_save_always_checks_ownership_even_without_owners_field(
    ...
    mock_security_manager.raise_for_ownership.side_effect = ZobiSecurityException(
        ZobiError(
    ...
    from zobi.commands.dataset.exceptions import DatasetForbiddenError
