"""Tests for zobi.views.datasource.utils module."""
...
@patch("zobi.views.datasource.utils.get_limit_clause")
def test_get_samples_raises_security_exception_when_access_denied(
    ...
    mock_samples_context.raise_for_access.side_effect = ZobiSecurityException(
        ZobiError(
...
def test_get_samples_count_star_access_denied(mock_get_limit_clause: MagicMock):
    ...
    mock_count_context.raise_for_access.side_effect = ZobiSecurityException(
        ZobiError(
