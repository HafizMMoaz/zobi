...
from zobi.common.query_actions import _detect_currency
...
@patch("zobi.common.query_actions.detect_currency_from_df")
...
@patch("zobi.common.query_actions.detect_currency")
