...
from zobi.semantic_layers.models import (
    ColumnMetadata,
    get_column_type,
    MetricMetadata,
    SemanticLayer,
...
def test_semantic_layer_implementation() -> None:
    ...
    with patch.dict(
        "zobi.semantic_layers.models.registry",
...
def test_semantic_view_data(
    ...
    from zobi.semantic_layers.models import SemanticLayer
...
def test_semantic_view_get_query_result(
    ...
    with patch(
        "zobi.semantic_layers.models.get_results",
...
def test_semantic_view_raise_for_access_denied(app: Any) -> None:
    """Test raise_for_access raises ZobiSecurityException when denied."""
    from zobi import security_manager
