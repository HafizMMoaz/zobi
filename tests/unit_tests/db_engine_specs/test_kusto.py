...
def test_sql_has_mutation(sql: str, expected: bool) -> None:
    ...
    from zobi.db_engine_specs.kusto import KustoSqlEngineSpec
...
def test_kql_convert_dttm(
    ...
    from zobi.db_engine_specs.kusto import KustoKqlEngineSpec as spec  # noqa: N813
...
def test_sql_convert_dttm(
    ...
    from zobi.db_engine_specs.kusto import KustoSqlEngineSpec as spec  # noqa: N813
