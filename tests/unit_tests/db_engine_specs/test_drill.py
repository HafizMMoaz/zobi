...
def test_odbc_impersonation(mocker: MockerFixture) -> None:
    ...
    from zobi.db_engine_specs.drill import DrillEngineSpec
...
def test_convert_dttm(
    ...
    from zobi.db_engine_specs.drill import DrillEngineSpec as spec  # noqa: N813
...
def test_connect_make_label_compatible(column_name: str, expected_result: str) -> None:
    from zobi.db_engine_specs.drill import (
