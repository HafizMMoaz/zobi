...
from zobi.reports.notifications.slackv2 import SlackV2Notification
...
def test_get_channel_with_multi_recipients(mock_header_data) -> None:
    ...
    from zobi.reports.notifications.slack import SlackNotification
...
@patch("zobi.reports.notifications.slackv2.g")
@patch("zobi.reports.notifications.slackv2.logger")
...
def test_send_slackv2(
    ...
    # `zobi.models.helpers`, a dependency of following imports,
...
@patch("zobi.reports.notifications.slack.g")
@patch("zobi.reports.notifications.slack.logger")
...
def test_slackv2_send_without_channels_raises(
    ...
    from zobi.reports.models import ReportRecipients, ReportRecipientType
    from zobi.reports.notifications.base import NotificationContent
    from zobi.reports.notifications.exceptions import NotificationParamException
