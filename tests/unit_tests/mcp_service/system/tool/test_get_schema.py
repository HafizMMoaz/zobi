...
class TestGetSchemaToolViaClient:
    ...
    @patch("zobi.daos.chart.ChartDAO.get_filterable_columns_and_operators")
    @pytest.mark.asyncio
    ...
    @patch("zobi.daos.dataset.DatasetDAO.get_filterable_columns_and_operators")
    @pytest.mark.asyncio
    ...
    @patch("zobi.daos.dashboard.DashboardDAO.get_filterable_columns_and_operators")
    @pytest.mark.asyncio
