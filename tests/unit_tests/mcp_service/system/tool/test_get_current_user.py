...
from zobi.mcp_service.chart.schemas import ChartFilter
from zobi.mcp_service.common.schema_discovery import (
    ColumnMetadata,
    ModelSchemaInfo,
)
from zobi.mcp_service.dashboard.schemas import DashboardFilter
...
from zobi.mcp_service.system.schemas import InstanceInfo, UserInfo
...
def test_redact_data_model_metadata_removes_dataset_and_database_summary():
    ...
    from zobi.mcp_service.system.tool.get_instance_info import (
...
def test_user_can_view_data_model_metadata_requires_stronger_dataset_permission(
    ...
    with patch("zobi.security_manager", new_callable=Mock) as mock_security_manager:
