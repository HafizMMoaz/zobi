...
query_dataset_module = importlib.import_module(
    "zobi.mcp_service.dataset.tool.query_dataset"
)
...
async def test_query_dataset_success(mcp_server: FastMCP) -> None:
    ...
    with (
        ...
        patch(
            "zobi.commands.chart.data.get_data_command.ChartDataCommand.validate",
        ),
        patch(
            "zobi.commands.chart.data.get_data_command.ChartDataCommand.run",
            return_value=result_data,
        ),
        patch(
            "zobi.common.query_context_factory.QueryContextFactory.create",
