...
def test_create_event_store_returns_none_when_no_redis_url():
    ...
    from zobi.mcp_service.server import create_event_store
...
def test_create_event_store_creates_event_store_with_redis():
    ...
    with patch(
        "zobi.mcp_service.server._create_redis_store",
...
def test_suppress_third_party_warnings():
    ...
    from zobi.mcp_service.server import _suppress_third_party_warnings
