...
from zobi.mcp_service.common.error_schemas import DatasetContext
...
generate_explore_link_module = importlib.import_module(
    "zobi.mcp_service.explore.tool.generate_explore_link"
)
...
def _mock_dataset(id: int = 1) -> Mock:
    ...
    from zobi.utils.core import ColumnSpec, GenericDataType
