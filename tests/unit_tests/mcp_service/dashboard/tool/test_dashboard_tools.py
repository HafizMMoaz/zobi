...
from zobi.mcp_service.dashboard.tool.get_dashboard_info import (
...
get_dashboard_info_module = import_module(
    "zobi.mcp_service.dashboard.tool.get_dashboard_info"
)
...
@patch("zobi.daos.dashboard.DashboardDAO.list")
@pytest.mark.asyncio
...
@patch(
    "zobi.mcp_service.dashboard.schemas.user_can_view_data_model_metadata",
    return_value=True,
)
...
class TestDashboardSortableColumns:
    ...
    def test_dashboard_sortable_columns_definition(self):
        ...
        from zobi.mcp_service.dashboard.tool.list_dashboards import (
