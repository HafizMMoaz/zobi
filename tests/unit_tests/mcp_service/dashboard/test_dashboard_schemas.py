...
from zobi.mcp_service.dashboard.schemas import (
...
class TestSerializeDashboardObject:
    ...
    @patch("zobi.mcp_service.utils.url_utils.get_zobi_base_url")
    ...
    def test_url_uses_id_when_no_slug(self, mock_base_url):
        ...
        assert result.url == "http://localhost:8088/zobi/dashboard/42/"
    ...
    def test_url_uses_slug_when_available(self, mock_base_url):
        ...
        assert result.url == "http://localhost:8088/zobi/dashboard/my-dashboard/"
    ...
    @patch("zobi.mcp_service.dashboard.schemas.user_can_view_data_model_metadata")
    @patch("zobi.mcp_service.utils.url_utils.get_zobi_base_url")
    ...
    def test_dashboard_serializer_restricted_user_redacts_data_model_metadata(
        ...
        dashboard = _mock_dashboard(id=1, slices=[chart])
        dashboard.url = "/zobi/dashboard/1/"
        dashboard.json_metadata = json_dumps(metadata)
    ...
    def test_descriptive_fields_are_sanitized(
        ...
        assert result.url == "http://localhost:8088/zobi/dashboard/safe-slug/"
