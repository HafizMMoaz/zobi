...
from zobi.mcp_service.middleware import LoggingMiddleware
...
class TestLoggingMiddlewareOnCallTool:
    ...
    @patch("zobi.mcp_service.middleware.get_user_id", return_value=42)
    @pytest.mark.asyncio
...
class TestExtractContextInfo:
    ...
    @patch("zobi.mcp_service.middleware.get_user_id", return_value=99)
    ...
    @patch(
        "zobi.mcp_service.middleware.get_user_id",
...
class TestMiddlewareChainOrder:
    ...
    async def test_real_middleware_chain_logs_exception_as_failure(
        ...
        from zobi.mcp_service.server import build_middleware_list
