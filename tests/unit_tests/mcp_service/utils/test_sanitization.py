...
from zobi.mcp_service.dashboard.schemas import DashboardError
from zobi.mcp_service.dataset.schemas import DatasetError
...
def test_sanitize_for_llm_context_preserves_excluded_operational_fields():
    payload = {
        "url": "https://zobi.example.com/dashboard/7",
...
def test_sanitize_for_llm_context_preserves_nested_operational_fields_in_lists():
    ...
    assert result["targets"][0]["url"] == "/zobi/explore/?slice_id=42"
