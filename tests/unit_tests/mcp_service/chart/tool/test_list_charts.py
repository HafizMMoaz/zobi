...
from zobi.mcp_service.constants import MAX_PAGE_SIZE
...
class TestChartDefaultColumnFiltering:
    ...
    def test_minimal_default_columns_constant(self):
        ...
        from zobi.mcp_service.common.schema_discovery import CHART_DEFAULT_COLUMNS
...
class TestChartDataModelMetadataPrivacy:
    ...
    def test_user_can_view_data_model_metadata_uses_dataset_permission(self):
        with patch("zobi.security_manager", new_callable=Mock) as security_manager:
...
@patch("zobi.daos.chart.ChartDAO.list")
@pytest.mark.asyncio
