...
from zobi.mcp_service.chart.tool.get_chart_preview import (
...
"""
    ...
    async def test_form_data_key_overrides_saved_params_for_table_preview(
        ...
        get_chart_preview_module = importlib.import_module(
            "zobi.mcp_service.chart.tool.get_chart_preview"
        )
        query_context_factory_module = importlib.import_module(
            "zobi.common.query_context_factory"
        )
        ...
        get_form_data_module = importlib.import_module(
            "zobi.commands.explore.form_data.get"
        )
    ...
    async def test_accessibility_metadata(self):
        ...
        from zobi.mcp_service.chart.schemas import AccessibilityMetadata
    ...
    async def test_performance_metadata(self):
        ...
        from zobi.mcp_service.chart.schemas import PerformanceMetadata
    ...
    def test_sanitize_chart_preview_wraps_interactive_html_but_keeps_urls(self):
        preview = ChartPreview(
            ...
            content=InteractivePreview(
                ...
                preview_url="/zobi/explore/?slice_id=6&standalone=1",
                width=800,
                height=600,
            ),
...
class TestDetachedInstanceError:
    ...
    async def test_session_refresh_called_after_chart_load(self):
        ...
        from zobi.mcp_service.chart.schemas import URLPreview
        ...
        with (
            ...
            from zobi.mcp_service.chart.schemas import GetChartPreviewRequest

            with patch("zobi.mcp_service.auth.get_user_from_request") as mu:
                mu.return_value = MagicMock(id=1, username="admin")
                with patch(
                    "zobi.mcp_service.auth.check_tool_permission", return_value=True
                ):
