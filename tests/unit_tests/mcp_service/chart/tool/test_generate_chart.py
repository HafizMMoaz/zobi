...
from zobi.mcp_service.chart.tool.generate_chart import (
    _compile_chart,
...
class TestGenerateChart:
    ...
    async def test_generate_chart_returns_table_chart_type_label(self) -> None:
        ...
        with (
            patch(
                "zobi.mcp_service.auth.get_user_from_request",
                return_value=mock_user,
            ),
            patch(
                "zobi.mcp_service.chart.validation.ValidationPipeline."
                "validate_request_with_warnings",
                return_value=validation_result,
            ),
            patch(
                "zobi.mcp_service.chart.chart_utils.generate_explore_link",
                return_value=(
...
class TestCompileChart:
    ...
    @patch("zobi.commands.chart.data.get_data_command.ChartDataCommand")
