...
update_chart_preview_module = importlib.import_module(
    "zobi.mcp_service.chart.tool.update_chart_preview"
)
...
class TestUpdateChartPreview:
    ...
    @patch("zobi.commands.explore.form_data.get.GetFormDataCommand")
    ...
    @patch("zobi.mcp_service.auth.get_user_from_request")
    @pytest.mark.asyncio
