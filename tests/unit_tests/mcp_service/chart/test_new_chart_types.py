...
from zobi.mcp_service.chart.validation.schema_validator import SchemaValidator
...
class TestMapPieConfig:
    ...
    def test_basic_pie_form_data(self) -> None:
        ...
        assert result["color_scheme"] == "zobiColors"
    ...
    def test_pie_form_data_color_scheme_override(self) -> None:
        """Explicit color_scheme overrides the zobiColors default."""
        config = PieChartConfig(
            chart_type="pie",
            dimension=ColumnRef(name="product"),
            metric=ColumnRef(name="revenue", aggregate="SUM"),
