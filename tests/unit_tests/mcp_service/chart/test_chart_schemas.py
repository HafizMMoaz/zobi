...
class TestTableChartConfig:
    ...
    def test_ag_grid_table_with_all_options(self) -> None:
        ...
        from zobi.mcp_service.chart.schemas import FilterConfig
...
class TestAliasChoices:
    """Test that common Zobi form_data aliases are accepted."""
    ...
    def test_mixed_timeseries_time_grain_sqla_alias(self) -> None:
        ...
        from zobi.mcp_service.chart.schemas import MixedTimeseriesChartConfig
...
class TestUnknownFieldDetection:
    ...
    def test_pie_chart_unknown_field(self) -> None:
        ...
        from zobi.mcp_service.chart.schemas import PieChartConfig
