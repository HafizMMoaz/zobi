...
from zobi.utils.oauth2 import decode_oauth2_state, encode_oauth2_state
...
def test_validate_success(
    ...
    mocker.patch("zobi.utils.oauth2.decode_oauth2_state", return_value=mock_state)
    mocker.patch.object(
...
def test_validate_database_not_found(
    ...
    mocker.patch(
        "zobi.utils.oauth2.decode_oauth2_state",
