...
def database_with_catalog(mocker: MockerFixture) -> MagicMock:
    ...
    """
    mocker.patch("zobi.commands.database.create.TestConnectionDatabaseCommand")
    ...
    DatabaseDAO = mocker.patch("zobi.commands.database.create.DatabaseDAO")  # noqa: N806
...
def test_create_with_oauth2(
    ...
    TestConnectionDatabaseCommand = mocker.patch(  # noqa: N806
        "zobi.commands.database.create.TestConnectionDatabaseCommand"
    )
