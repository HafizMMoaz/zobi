...
def test_csv_reader_engine_selection():
    ...
    with patch("zobi.commands.database.uploaders.csv_reader.pd") as mock_pd:
        with patch(
            "zobi.commands.database.uploaders.csv_reader.is_feature_enabled"
        ) as mock_flag:
...
def test_csv_reader_select_optimal_engine():
    ...
    with patch("zobi.commands.database.uploaders.csv_reader.util") as mock_util:
        with patch("zobi.commands.database.uploaders.csv_reader.pd") as mock_pd:
            with patch("zobi.commands.database.uploaders.csv_reader.logger"):
