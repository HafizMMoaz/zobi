...
def test_update_with_catalog(
    ...
    """
    database_dao = mocker.patch("zobi.commands.database.update.DatabaseDAO")
    ...
    sync_db_perms_dao = mocker.patch(
        "zobi.commands.database.sync_permissions.DatabaseDAO"
    )
    sync_db_perms_dao.find_by_id.return_value = database_with_catalog
    mocker.patch("zobi.commands.database.update.get_username")
    mocker.patch("zobi.security_manager.get_user_by_username")
    ...
    add_pvm = mocker.patch("zobi.commands.database.sync_permissions.add_pvm")
...
def test_update_sync_perms_in_async_mode(
    ...
    mocker.patch("zobi.commands.database.update.get_username", return_value="admin")
    mocker.patch("zobi.security_manager.get_user_by_username")
...
def test_rename_with_catalog(
    ...
    dataset_dao = mocker.patch("zobi.commands.database.sync_permissions.DatasetDAO")
    ...
    add_pvm = mocker.patch("zobi.commands.database.sync_permissions.add_pvm")
    add_vm = mocker.patch("zobi.commands.database.sync_permissions.add_vm")
...
def test_update_with_catalog_change(mocker: MockerFixture) -> None:
    ...
    mocker.patch("zobi.commands.database.update.SyncPermissionsCommand")
    mocker.patch.object(
        UpdateDatabaseCommand,
        "validate",
    )
