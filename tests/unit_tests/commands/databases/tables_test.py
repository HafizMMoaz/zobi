...
def database_with_catalog(mocker: MockerFixture) -> MagicMock:
    ...
    """
    mocker.patch("zobi.commands.database.tables.db")
    ...
    DatabaseDAO = mocker.patch("zobi.commands.database.tables.DatabaseDAO")  # noqa: N806
...
def test_tables_with_catalog(
    ...
    db = mocker.patch("zobi.commands.database.tables.db")
