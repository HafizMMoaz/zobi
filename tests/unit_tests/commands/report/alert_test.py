...
from zobi.commands.report.exceptions import AlertValidatorConfigError
from zobi.reports.models import ReportScheduleValidatorType, ReportState
...
def test_empty_query_result_with_operator_validator_returns_false_with_message(
    ...
    mocker.patch(
        "zobi.commands.report.alert.retry_call",
...
def test_empty_result_flow_sets_noop_state(mocker: MockerFixture) -> None:
    ...
    from zobi.commands.report.execute import ReportNotTriggeredErrorState
