...
from zobi.commands.exceptions import TagForbiddenError, TagNotFoundValidationError
from zobi.commands.utils import (
    compute_owner_list,
    populate_owner_list,
    Tag,
    TagType,
...
@patch("zobi.commands.utils.g")
@patch("zobi.commands.utils.security_manager")
@patch("zobi.commands.utils.get_user_id")
...
@patch("zobi.commands.utils.populate_owner_list")
...
@pytest.mark.parametrize("object_type", OBJECT_TYPES)
@patch("zobi.commands.utils.security_manager")
@patch("zobi.commands.utils.TagDAO.find_by_id")
...
@pytest.mark.parametrize("object_type", OBJECT_TYPES)
@patch("zobi.commands.utils.security_manager")
@patch("zobi.commands.utils.TagDAO.find_by_name")
...
@pytest.mark.parametrize("object_type", OBJECT_TYPES)
@patch("zobi.commands.utils.TagDAO")
