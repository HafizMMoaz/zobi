...
@patch("zobi.commands.chart.warm_up_cache.get_dashboard_extra_filters")
@patch("zobi.commands.chart.warm_up_cache.ChartDataCommand")
def test_applies_dashboard_filters_to_non_legacy_chart(
    ...
    with patch.object(chart, "get_query_context", return_value=mock_qc):
        with patch(
            "zobi.commands.chart.warm_up_cache.get_form_data",
...
@patch("zobi.commands.chart.warm_up_cache.viz_types", ["table"])
...
@patch("zobi.commands.chart.warm_up_cache.get_dashboard_extra_filters")
@patch("zobi.commands.chart.warm_up_cache.get_viz")
@patch("zobi.commands.chart.warm_up_cache.viz_types", ["table"])
@patch("zobi.commands.chart.warm_up_cache.g")
...
@patch("zobi.commands.chart.warm_up_cache.db")
...
def test_validate_with_nonexistent_chart_id(mock_db):
    ...
    from zobi.commands.chart.exceptions import WarmUpCacheChartNotFoundError
