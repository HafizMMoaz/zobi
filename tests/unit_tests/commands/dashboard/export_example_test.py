...
from zobi.commands.dashboard.export_example import (
...
def test_export_example_command_not_found():
    ...
    with patch("zobi.commands.dashboard.export_example.DashboardDAO") as mock_dao:
...
def test_export_example_command_single_dataset():
    ...
    with (
        patch("zobi.commands.dashboard.export_example.DashboardDAO") as mock_dao,
        patch(
            "zobi.commands.dashboard.export_example.export_dataset_data"
        ) as mock_export_data,
    ):
