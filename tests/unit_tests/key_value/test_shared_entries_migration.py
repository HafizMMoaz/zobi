...
def test_get_shared_value_fallback_to_md5() -> None:
    ...
    from zobi.key_value.shared_entries import get_shared_value
    ...
    with patch("zobi.key_value.shared_entries.KeyValueDAO", mock_dao):
        with patch("zobi.key_value.utils.current_app", mock_app):
