...
from zobi.utils import decorators
...
def test_statsd_gauge(
    ...
    with patch("zobi.extensions.stats_logger_manager.instance.gauge") as mock:
        cm = (
