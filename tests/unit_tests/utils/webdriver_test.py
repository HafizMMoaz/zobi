...
class TestWebDriverSelenium:
    ...
    @patch("zobi.utils.webdriver.app")
    @patch("zobi.utils.webdriver.firefox")
    @patch("zobi.utils.webdriver.chrome")
...
class TestPlaywrightAvailabilityCheck:
    ...
    @patch("zobi.utils.webdriver.sync_playwright", None)
    ...
    @patch("zobi.utils.webdriver.sync_playwright")
    @patch("zobi.utils.webdriver.logger")
...
class TestWebDriverPlaywrightFallback:
    ...
    @patch("zobi.utils.webdriver.PLAYWRIGHT_AVAILABLE", True)
    @patch("zobi.utils.webdriver.sync_playwright")
    @patch("zobi.utils.webdriver.app")
    ...
    def test_get_screenshot_handles_playwright_timeout(
        ...
        from zobi.utils.webdriver import PlaywrightTimeout
        ...
        with patch("zobi.utils.webdriver.app") as mock_app:
            mock_app.config = {
                "WEBDRIVER_OPTION_ARGS": [],
                "WEBDRIVER_WINDOW": {"pixel_density": 1},
                "SCREENSHOT_PLAYWRIGHT_DEFAULT_TIMEOUT": 30000,
...
class TestWebDriverConstantsWithImportError:
    ...
    def test_dummy_classes_when_playwright_unavailable(self):
        ...
        import zobi.utils.webdriver as webdriver_module
...
class TestWebDriverPlaywrightErrorHandling:
    ...
    def test_find_unexpected_errors_handles_playwright_error(
        ...
        from zobi.utils.webdriver import PlaywrightError
