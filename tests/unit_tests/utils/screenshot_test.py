...
BASE_SCREENSHOT_PATH = "zobi.utils.screenshots.BaseScreenshot"
...
class TestBaseScreenshotDriverFallback:
    ...
    @patch("zobi.utils.screenshots.PLAYWRIGHT_AVAILABLE", True)
    ...
    @patch("zobi.utils.screenshots.logger")
    @patch("zobi.utils.screenshots.PLAYWRIGHT_AVAILABLE", False)
    @patch("zobi.extensions.feature_flag_manager.is_feature_enabled")
