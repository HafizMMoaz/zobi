...
from zobi.utils.hashing import (
    hash_from_dict,
    hash_from_str,
)
...
def test_hash_from_str_sha256():
    ...
    with patch("zobi.utils.hashing.get_hash_algorithm", return_value="sha256"):
...
def test_hash_from_str_md5():
    ...
    with patch("zobi.utils.hashing.get_hash_algorithm", return_value="md5"):
        result = hash_from_str("test")
