...
def test_get_dataset_config_from_yaml_extracts_uuid():
    ...
    from zobi.examples.data_loading import get_dataset_config_from_yaml
...
def test_get_multi_dataset_config_extracts_uuid():
    ...
    from zobi.examples.data_loading import _get_multi_dataset_config
...
def test_discover_datasets_passes_uuid_to_loader():
    ...
    from zobi.examples.data_loading import discover_datasets
    ...
    with TemporaryDirectory() as tmpdir:
        ...
        with patch(
            "zobi.examples.data_loading.get_examples_directory",
            return_value=examples_dir,
        ):
            with patch(
                "zobi.examples.data_loading.create_generic_loader"
            ) as mock_create:
