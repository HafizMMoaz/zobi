...
@patch("zobi.examples.generic_loader.get_example_database")
@patch("zobi.examples.generic_loader.db")
def test_load_parquet_table_sets_uuid_on_new_table(mock_db, mock_get_db):
    ...
    from zobi.examples.generic_loader import load_parquet_table
    ...
    with patch("zobi.examples.generic_loader.inspect") as mock_inspect:
...
def test_create_generic_loader_passes_uuid():
    ...
    from zobi.examples.generic_loader import create_generic_loader
    ...
    with patch("zobi.examples.generic_loader.load_parquet_table") as mock_load:
