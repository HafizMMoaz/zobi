...
import zobi.commands.distributed_lock.acquire as acquire_module
import zobi.commands.distributed_lock.release as release_module
from zobi import db
from zobi.distributed_lock import DistributedLock
from zobi.distributed_lock.types import LockValue
from zobi.distributed_lock.utils import get_key
from zobi.exceptions import AcquireDistributedLockFailedException
...
def test_distributed_lock_default_ttl(app_context: None) -> None:
    ...
    from zobi.commands.distributed_lock.base import get_default_lock_ttl
