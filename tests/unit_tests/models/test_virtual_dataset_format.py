...
from zobi.sql.parse import RLSMethod, SQLStatement, Table
...
class TestVirtualDatasetNoRLS:
    ...
    @patch("zobi.models.helpers.apply_rls", return_value=False)
...
class TestVirtualDatasetWithRLS:
    ...
    @patch("zobi.models.helpers.apply_rls", return_value=True)
...
class TestApplyRlsReturnValue:
    ...
    @patch("zobi.utils.rls.get_predicates_for_table")
