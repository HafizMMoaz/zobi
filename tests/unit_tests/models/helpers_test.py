...
def _run_probe(
    ...
    with (
        patch(
            "zobi.connectors.sqla.models.get_columns_description",
...
def _adhoc_col_with_probed_type(
    ...
    def fake_get_columns_description(
        ...
        """Return a single-column description mirroring ZobiResultSet output."""
        # Mirror what ZobiResultSet.columns builds: it derives type_generic
...
def test_format_time_humanized_activates_non_english_locale(
    ...
    mocker.patch(
        "zobi.models.helpers.get_locale",
        return_value="es",  # Spanish
    )
    mock_activate = mocker.patch("zobi.models.helpers.humanize.i18n.activate")
    mock_deactivate = mocker.patch("zobi.models.helpers.humanize.i18n.deactivate")
