...
from zobi_core.tasks.types import TaskContext, TaskScope

if TYPE_CHECKING:
    from zobi_core.tasks.models import Task
...
def task(
    ...
    :param name: Optional unique task name (e.g., "zobi.generate_thumbnail").
    ...
    Example:
        from zobi_core.tasks.decorators import task, get_context
