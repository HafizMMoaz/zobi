"""
Semantic layer DAO interfaces for core.
...
Usage:
    from zobi_core.semantic_layers.daos import (
...
from zobi_core.semantic_layers.models import SemanticLayerModel, SemanticViewModel
