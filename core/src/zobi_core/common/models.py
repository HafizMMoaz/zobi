...
Usage:
    from zobi_core.common.models import Dataset, Database, get_session
...
class CoreModel(Model):
    ...
    This base class provides the interface contract for all Zobi models.
...
class Database(CoreModel):
    ...
    def execute(
        ...
        Example:
            from zobi_core.common.daos import DatabaseDAO
            from zobi_core.queries.types import QueryOptions, QueryStatus
