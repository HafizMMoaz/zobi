...
import { clearDatasetCache } from 'src/utils/cachedZobiGet';
...
> {
  ...
  async fetchUsageData(
    ...
    try {
      ...
      const { json = {} } = await ZobiClient.get({
                  ...
                  <Field
                    ...
                    description={t(
                      'When specifying SQL, the datasource acts as a view. ' +
                        'Zobi will use this statement as a subquery while grouping and filtering ' +
                ...
                <Field
                  ...
                  description={t(
                    'The pointer to a physical table (or view). Keep in mind that the chart is ' +
                      'associated to this Zobi logical table, and this logical table points ' +
