...
export function runAnnotationQuery({
  ...
  return async function (
    ...
    const queryTimeout = timeout || common.conf.ZOBI_WEBSERVER_TIMEOUT || 0;
...
export function exploreJSON(
  ...
  return async (
    ...
    const queryTimeout =
      timeout || state.common.conf.ZOBI_WEBSERVER_TIMEOUT || 0;
    ...
    getChartDataRequest({
      ...
      .then(({ json }) => {
        ...
        if (history) {
          ...
          ZobiClient.postForm(redirectUrl, {
