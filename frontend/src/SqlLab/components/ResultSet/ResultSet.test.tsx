...
describe('ResultSet', () => {
  ...
  test.each([
    ...
    },
    {
      ...
      appRoot: '/zobi',
      expectedUrl: '/zobi/api/v1/sqllab/export_streaming/',
    },
    {
      name: 'with nested subdirectory prefix',
      appRoot: '/my-app/zobi',
      expectedUrl: '/my-app/zobi/api/v1/sqllab/export_streaming/',
    },
  ])(
    ...
    const { queryByTestId } = setup(
      ...
      mockStore({
        ...
        user: {
          ...user,
          roles: {
            sql_lab: [['can_copy_clipboard', 'Zobi']],
          },
        },
        sqlLab: {
          ...initialState.sqlLab,
