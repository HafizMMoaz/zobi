...
export const labelMarginBottom = (theme: ZobiTheme) => css`
  margin-bottom: ${theme.sizeUnit * 2}px;
`;

export const marginBottom = (theme: ZobiTheme) => css`
...
export const infoTooltip = (theme: ZobiTheme) => css`
...
export const toggleStyle = (theme: ZobiTheme) => css`
  padding-left: ${theme.sizeUnit * 2}px;
  padding-right: ${theme.sizeUnit * 2}px;
`;

export const formScrollableStyles = (theme: ZobiTheme) => css`
...
export const antDAlertStyles = (theme: ZobiTheme) => css`
...
export const formHelperStyles = (theme: ZobiTheme) => css`
  .required {
...
export const wideButton = (theme: ZobiTheme) => css`
  width: 100%;
...
export const validatedFormStyles = (theme: ZobiTheme) => css`
  label {
...
export const buttonLinkStyles = (theme: ZobiTheme) => css`
  text-transform: initial;
  padding: 0 ${theme.sizeUnit * 4}px;
  padding-right: ${theme.sizeUnit * 2}px;
`;

export const importDbButtonLinkStyles = (theme: ZobiTheme) => css`
  font-size: ${theme.sizeUnit * 3.5}px;
  text-transform: initial;
  padding-right: ${theme.sizeUnit * 2}px;
`;

export const alchemyButtonLinkStyles = (theme: ZobiTheme) => css`
  text-transform: initial;
  margin-left: 0px;
