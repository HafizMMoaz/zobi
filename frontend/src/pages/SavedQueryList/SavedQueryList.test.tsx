...
describe('SavedQueryList', () => {
  ...
  test('"+ Query" button pushes a router-relative path (subdirectory deployment)', async () => {
    // Simulate ZOBI_APP_ROOT=/zobi. ensureAppRoot/makeUrl read
    // applicationRoot() dynamically, so mocking it here makes the buggy code
    // path (makeUrl() around history.push) produce '/zobi/sqllab?new=true'
    ...
    try {
      ...
      await waitFor(() => {
        ...
        // re-applied the app root would produce '/zobi/sqllab?new=true'.
