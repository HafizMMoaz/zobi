...
const Chart = (props: ChartProps) => {
  ...
  const zobiCanExplore = useSelector(
    (state: RootState) =>
  ...
  const timeout: number = useSelector(
    (state: RootState) =>
      state.dashboardInfo.common.conf.ZOBI_WEBSERVER_TIMEOUT as number,
  );
  ...
  return (
    ...
    >
      <SliceHeader
        ...
        zobiCanExplore={zobiCanExplore}
        zobiCanShare={zobiCanShare}
        zobiCanCSV={zobiCanCSV}
      ...
      {/*
          ...
          markdown that is sanitized with nh3. See:
             https://github.com/HafizMMoaz/zobi/pull/4390
          and
             https://github.com/HafizMMoaz/zobi/pull/23862
        */}
