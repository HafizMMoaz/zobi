...
const headerContainerStyle = (theme: ZobiTheme) => css`
  border-bottom: 1px solid ${theme.colorBorder};
`;

const editButtonStyle = (theme: ZobiTheme) => css`
  color: ${theme.colorPrimary};
`;

const actionButtonsStyle = (theme: ZobiTheme) => css`
  display: flex;
  align-items: center;
...
const undoRedoStyle = (theme: ZobiTheme) => css`
...
const undoRedoEmphasized = (theme: ZobiTheme) => css`
  color: ${theme.colorIcon};
`;

const undoRedoDisabled = (theme: ZobiTheme) => css`
  color: ${theme.colorTextDisabled};
`;

const saveBtnStyle = (theme: ZobiTheme) => css`
...
const discardBtnStyle = (theme: ZobiTheme) => css`
...
const Header = (): JSX.Element => {
  ...
  const overwriteDashboard = useCallback(() => {
    ...
    const limit =
      dashboardInfo.common?.conf?.ZOBI_DASHBOARD_POSITION_DATA_LIMIT ||
      DASHBOARD_POSITION_DATA_LIMIT;
  ...
  const userCanCurate =
    isFeatureEnabled(FeatureFlag.EmbeddedZobi) &&
