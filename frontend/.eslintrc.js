...
module.exports = {
  ...
  rules: {
    ...
    // Core ESLint overrides for Zobi
    'no-console': 'warn',
  ...
  overrides: [
    ...
    // Ban JavaScript files in packages/ - with exceptions for config files and generators
    {
      ...
      excludedFiles: [
        'packages/generator-zobi/**/*', // Yeoman generator templates run via Node
        ...
        'no-restricted-imports': [
          'error',
          {
            paths: [
              ...
              restrictedImportsRules['no-zobi-theme'],
            ],
            patterns: [],
          },
        ],
