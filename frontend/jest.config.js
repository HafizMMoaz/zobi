...
module.exports = {
  ...
  transformIgnorePatterns: [
    // @ant-design/icons resolves @ant-design/colors/es/generate from its CJS
    // lib build, and that ESM entry imports @ant-design/fast-color. Both need
    // transforming rather than being skipped as plain node_modules.
    'node_modules/(?!@ant-design/colors|@ant-design/fast-color|d3-(array|interpolate|color|time|scale|time-format|format)|internmap|@mapbox/tiny-sdf|remark-gfm|(?!@ngrx|(?!deck.gl)|d3-scale)|markdown-table|micromark-*.|decode-named-character-reference|character-entities|mdast-util-*.|unist-util-*.|ccount|escape-string-regexp|nanoid|uuid|@rjsf/*.|echarts|zrender|fetch-mock|pretty-ms|parse-ms|ol|@babel/runtime|@emotion|cheerio|cheerio/lib|parse5|dom-serializer|entities|htmlparser2|rehype-sanitize|hast-util-sanitize|unified|unist-.*|hast-.*|rehype-.*|remark-.*|mdast-.*|micromark-.*|parse-entities|property-information|space-separated-tokens|comma-separated-tokens|bail|devlop|zwitch|longest-streak|geostyler|geostyler-.*|(?!geostyler)lodash|react-error-boundary|react-json-tree|react-base16-styling|lodash-es|rbush|quickselect|react-diff-viewer-continued|@assistant-ui/.*|assistant-stream|assistant-cloud|@assistant-ui/tap|@assistant-ui/store|radix-ui|@radix-ui/.*|react-textarea-autosize|safe-content-frame|zustand|zod)',
  ],
  preset: 'ts-jest',
  transform: {
