...
export type { Metric } from '@zobi.dev/core';
...
// Ref:frontend/src/explore/store.js
...
// Ref: frontend/src/explore/components/ControlPanelsContainer.jsx
...
// Ref: frontend/src/explore/components/controls/index.js
...
> extends AnyDict {
  ...
  label?:
    ...
    | ((
        ...
        // TODO: add strict `chartState` typing (see frontend/src/explore/types)
        chartState?: AnyDict,
      ) => ReactNode);
  description?:
    | ReactNode
...
// Ref: frontend/@zobi.dev/core/components/Select/ZobiStyledSelect.tsx
...
export type CustomControlConfig<P = {}> = BaseControlConfig<ComponentType<P>> &
  // two run-time properties from frontend/src/explore/components/Control.jsx
...
// Ref:
//  - frontend/src/explore/components/ControlPanelsContainer.jsx
//  - frontend/src/explore/components/ControlPanelSection.jsx
...
// Ref:
//  - frontend/src/explore/components/ConditionalFormattingControl.tsx
