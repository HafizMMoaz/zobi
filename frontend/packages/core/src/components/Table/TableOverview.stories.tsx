...
Common table applications in Zobi:
...
\`\`\`
import { alphabeticalSort } from '@zobi.dev/core/components/Table/sorters';
...
you can register \`onDragOver\` and \`onDragDrop\` event handlers on the destination component. In the \`onDragDrop\` handler you can check for \`ZOBI_TABLE_COLUMN\`
as the getData key as shown below.

\`\`\`
import { ZOBI_TABLE_COLUMN } from '@zobi.dev/core/components/table';

const handleDrop = (ev:Event) => {
  const json = ev.dataTransfer?.getData?.(ZOBI_TABLE_COLUMN);
