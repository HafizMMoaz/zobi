...
the available width, they are displayed vertically in a dropdown. Some of the common applications in Zobi are:
...
The component accepts any React element which ensures a high level of variability in Zobi.
