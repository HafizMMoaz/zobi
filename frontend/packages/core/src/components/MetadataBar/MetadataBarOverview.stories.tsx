...
Some of the common applications in Zobi are:
...
This process is important to make sure the new type is reviewed by the design team, improving Zobi consistency.
