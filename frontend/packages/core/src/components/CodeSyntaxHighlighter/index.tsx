...
import { css, isThemeDark, useTheme } from '@zobi.dev/extension-api/theme';
...
/**
 * A themed syntax highlighter component that automatically adapts to Zobi's current theme.
