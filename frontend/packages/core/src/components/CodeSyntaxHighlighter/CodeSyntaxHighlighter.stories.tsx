import { Typography, Flex, Space } from '@zobi.dev/core/components';
...
A **themed syntax highlighter** for Zobi that supports multiple languages and automatic theme switching.
...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "A themed syntax highlighter component that automatically adapts to Zobi's light/dark themes and supports lazy loading of languages.",
      },
    },
  },
};
