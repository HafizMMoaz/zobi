...
/**
 * This type defines all available extensions of Zobi's default UI.
 * Namespace the keys here to follow the form of 'some_domain.functionality.item'.
 * Take care to name your keys well, as the name describes what this extension point's role is in Zobi.
 *
...
export interface DatabaseConnectionExtension {
   ...
   * Callbacks
   */
  // TODO: we need to move the db types to zobi-ui/core in order to import them correctly
