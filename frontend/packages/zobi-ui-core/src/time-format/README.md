...
```js
import { formatTime } from '@zobi-ui/core';
...
```js
import { getTimeFormatterRegistry, formatTime, TimeFormatter } from '@zobi-ui/core';
...
[TimeFormats.js](https://github.com/HafizMMoaz/zobi/blob/master/frontend/packages/zobi-ui-core/src/time-format/TimeFormats.ts).
