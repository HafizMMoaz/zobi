...
```js
import { getNumberFormatterRegistry, formatNumber, NumberFormatter } from '@zobi-ui/core';
...
[NumberFormats.js](https://github.com/HafizMMoaz/zobi/blob/master/frontend/packages/zobi-ui-core/src/number-format/NumberFormats.ts).

```js
import { NumberFormats } from '@zobi-ui-number-format';
...
```js
import { createDurationFormatter, formatNumber, getNumberFormatterRegistry } from '@zobi-ui-number-format';
