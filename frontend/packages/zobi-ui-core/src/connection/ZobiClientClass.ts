...
export default class ZobiClientClass {
  ...
  isAuthenticated(): boolean {
    // if CSRF protection is disabled in the Zobi app, the token may be an empty string
  ...
  async ensureAuth(): CsrfPromise {
    return (
      ...
      Promise.reject({
        error: `ZobiClient has not been provided a CSRF token, ensure it is
