...
import { ThemeProvider, zobiTheme } from '@zobi/core-legacy/theme';
import * as uiModule from '@zobi/core-legacy/theme';
...
test('applies custom theme colors from Zobi theme', () => {
  const customTheme = {
    ...zobiTheme,
