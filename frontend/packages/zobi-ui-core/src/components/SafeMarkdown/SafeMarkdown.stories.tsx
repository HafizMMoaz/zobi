...
Visit https://zobi.dev for more info.
...
<a href="https://zobi.dev">Safe link</a>
          `}
          htmlSanitization
        />
      </div>
...
DashboardUseCases.parameters = {
  docs: {
    description: {
      story:
        'Real-world examples of how SafeMarkdown is used in Zobi dashboards for chart descriptions, data quality notes, and metric definitions.',
    },
  },
};
