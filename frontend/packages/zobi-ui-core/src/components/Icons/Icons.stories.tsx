...
import { styled, zobiTheme } from '@zobi/core-legacy/theme';
...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Icon library for Zobi. Contains over 200 icons based on Ant Design icons with consistent sizing and theming support.',
      },
    },
  },
};
...
const palette: Record<string, string | null> = {
  Default: null,
  Primary: zobiTheme.colorPrimary,
  Success: zobiTheme.colorSuccess,
  Warning: zobiTheme.colorWarning,
  Error: zobiTheme.colorError,
  Info: zobiTheme.colorInfo,
  Text: zobiTheme.colorText,
  'Text Secondary': zobiTheme.colorTextSecondary,
  Icon: zobiTheme.colorIcon,
};
