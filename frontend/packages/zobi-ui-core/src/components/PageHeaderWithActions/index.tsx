...
import { css, ZobiTheme, useTheme } from '@zobi/core-legacy/theme';
...
export const menuTriggerStyles = (theme: ZobiTheme) => css`
...
const headerStyles = (theme: ZobiTheme) => css`
  display: flex;
  flex-direction: row;
  align-items: center;
  flex-wrap: nowrap;
...
const buttonsStyles = (theme: ZobiTheme) => css`
  display: flex;
  align-items: center;
...
const additionalActionsContainerStyles = (theme: ZobiTheme) => css`
