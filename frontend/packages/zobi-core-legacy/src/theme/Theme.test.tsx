...
test('Theme base theme integration works with real-world Zobi base theme configuration', () => {
  // Simulate actual Zobi base theme (THEME_DEFAULT/THEME_DARK from config)
  const zobiBaseTheme: AnyThemeConfig = {
    token: {
      colorPrimary: '#2893B3',
      colorError: '#e04355',
      colorWarning: '#fcc700',
  ...
  // Test light mode
  const lightTheme = Theme.fromConfig(themeDefault, zobiBaseTheme);
