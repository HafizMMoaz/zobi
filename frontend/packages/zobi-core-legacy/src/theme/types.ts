...
export interface ZobiSpecificTokens {
  ...
  // Secondary button tokens (Zobi-specific)
 ...
 * we actually allow in the ZobiTheme.
 */
...
/** The final shape for our custom theme object, combining shared antd + zobi specifics. */
export type ZobiTheme = SharedAntdTokens & ZobiSpecificTokens;
 ...
 */
export interface ZobiThemeConfig {
