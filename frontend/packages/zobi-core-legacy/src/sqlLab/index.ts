 ...
 *
 * This module provides interfaces and functions for integrating with Zobi's SQL Lab,
...
import { Event, Database, ZobiError, Column } from '../common';
...
export interface QueryErrorResultContext extends QueryContext {
  ...
  /**
   * Error details in a ZobiError structure
   */
  errors: ZobiError[] | null;
...
/**
 * Gets all available databases in the Zobi instance.
 *
