...
import type { ZobiTheme } from '../theme';
 ...
 * This interface defines the contract between Zobi and editor components,
...
export interface EditorProps {
  ...
  metadata?: Record<string, unknown>;
  /** Theme object for styling the editor to match Zobi's appearance */
  theme?: ZobiTheme;
}
 ...
 * It can be used by any part of Zobi that needs to manipulate editor content,
