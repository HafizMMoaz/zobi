# @zobi.dev/extension-api

[![npm version](https://badge.fury.io/js/%40zobi.dev%2Fcore.svg)](https://badge.fury.io/js/%40zobi.dev%2Fcore)
...
```bash
npm install @zobi.dev/extension-api
```
...
```typescript
import { commands } from '@zobi.dev/extension-api';
...
```typescript
import { menus } from '@zobi.dev/extension-api';
