...
/**
 * Custom rule checker for Zobi-specific linting patterns
...
const TECHNICAL_TERMS = new Set([
  ...
  'CAST',
  'CONVERT',
  // SQL date functions (common in Zobi)
  'DATETIME',
  'DATEADD',
  'DATETRUNC',
  'LASTDAY',
...
function main() {
  ...
  if (files.length === 0) {
    ...
    // Filter to only JS/TS files and remove frontend prefix
    files = files
  ...
  // eslint-disable-next-line no-console
  console.log(`Checking ${files.length} files for Zobi custom rules...\n`);
