...
// output dir
const BUILD_DIR = path.resolve(__dirname, '../zobi/static/assets');
...
const config = {
  ...
  resolve: {
    // resolve modules from `/zobi_frontend/node_modules` and `/zobi_frontend`
    modules: [
      'node_modules',
      APP_DIR,
...
if (process.env.BUNDLE_ANALYZER) {
  ...
  config.plugins.push(
    ...
    // you'll find it at zobi/static/stats/statistics.html
