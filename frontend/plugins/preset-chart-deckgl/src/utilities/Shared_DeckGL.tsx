...
const sandboxUrl =
  'https://github.com/HafizMMoaz/zobi/' +
  'blob/master/frontend/plugins/preset-chart-deckgl/src/utils/sandbox.ts';
  ...
  config: {
    ...
    description: t(
      'Select the map tile provider. MapLibre is open-source and requires no API key. ' +
        'Mapbox requires MAPBOX_API_KEY to be configured in Zobi.',
    ),
  },
};
