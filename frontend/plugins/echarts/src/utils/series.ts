...
import { SortSeriesType, LegendPaddingType } from '@zobi.dev/chart-controls';
...
function measureLegendTextWidth(text: string, theme: ZobiTheme): number {
...
function getLegendItemWidths(labels: string[], theme: ZobiTheme): number[] {
  return labels.map(
    label =>
