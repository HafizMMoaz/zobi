...
const streamReturnValue: server.StreamResult[] = [
  [
    ...
    [
      'data',
      `{"channel_id": "${channelId}", "job_id": "c9b99965-8f1e-4ce5-aa43-d6fc94d6a510", "user_id": "1", "status": "done", "errors": [], "result_url": "/zobi/explore_json/data/ejr-37281682b1282cdb8f25e0de0339b386"}`,
    ],
  ],
  [
    '1615426152516-0',
...
describe('server', () => {
  ...
  describe('processStreamResults', () => {
    test('sends data to channel', async () => {
      ...
      const message1 = `{"id":"1615426152415-0","channel_id":"${channelId}","job_id":"c9b99965-8f1e-4ce5-aa43-d6fc94d6a510","user_id":"1","status":"done","errors":[],"result_url":"/zobi/explore_json/data/ejr-37281682b1282cdb8f25e0de0339b386"}`;
