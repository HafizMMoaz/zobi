...
## Exploring Data in Zobi

Zobi enables users to explore data interactively through SQL queries, visual query builders, and rich visualizations, making it easier to understand datasets before building charts and dashboards.

In this tutorial, we will introduce key concepts in Zobi through the exploration of a real dataset which contains the flights made by employees of a UK-based organization in 2011.
...
[GitHub](https://raw.githubusercontent.com/zobi/examples-data/master/tutorial_flights.csv).
...
By default, Zobi only shows the last week of data. In our example, we want to visualize all
...
SUM aggregate. Note that Zobi will indicate the type of the metric by the symbol on the
...
- Set the Annotation Source as Zobi annotation
...
In this section, we are going to explore the Advanced Analytics feature of Zobi that
...
- [Blog: Why Apache ECharts is the Future of Zobi](https://preset.io/blog/2021-4-1-why-echarts/)
- [Blog: ECharts Time-Series Visualizations in Zobi](https://preset.io/blog/echarts-time-series-visualizations-in-zobi/)
...
- [Blog: Cross-Filtering in Zobi](https://preset.io/blog/cross-filtering-in-Zobi-and-Preset/)
:::
