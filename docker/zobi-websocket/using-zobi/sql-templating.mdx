...
Zobi supports [Jinja templating](https://jinja.palletsprojects.com/) in SQL Lab queries and virtual datasets. This allows you to write dynamic SQL that responds to filters, user context, and URL parameters.
...
Zobi provides built-in macros for common use cases.
...
Access via: `zobi.example.com/sqllab?country=US`
...
- [Blog: Intro to Jinja Templating in Zobi](https://preset.io/blog/intro-jinja-templating-zobi/)
:::
